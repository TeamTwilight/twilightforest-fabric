...
public class BrazierRenderer implements BlockEntityRenderer<BrazierBlockEntity> {
	...
	public BrazierRenderer(BlockEntityRendererProvider.Context context) {
		this.model = new BrazierModel(context.bakeLayer(CodexModelLayers.BRAZIER));
	}

	@Override
	public void render(BrazierBlockEntity entity, float partialTick, PoseStack stack, MultiBufferSource buffer, int light, int overlay) {
		...
		ResourceLocation loc = lit.isLit() ? TEXTURE_ON : TEXTURE_OFF;
