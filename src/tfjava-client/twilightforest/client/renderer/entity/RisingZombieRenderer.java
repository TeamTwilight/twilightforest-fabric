...
public class RisingZombieRenderer extends TFBipedRenderer<RisingZombie, RisingZombieModel> {
	public RisingZombieRenderer(EntityRendererProvider.Context context) {
		super(context, new RisingZombieModel(context.bakeLayer(CodexModelLayers.RISING_ZOMBIE)), new RisingZombieModel(context.bakeLayer(ModelLayers.ZOMBIE_INNER_ARMOR)), new RisingZombieModel(context.bakeLayer(ModelLayers.ZOMBIE_OUTER_ARMOR)), 0.5F, "textures/entity/zombie/zombie.png");
	}
