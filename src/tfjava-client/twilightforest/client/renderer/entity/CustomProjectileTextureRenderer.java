 ...
 */
public class CustomProjectileTextureRenderer<T extends Entity> extends EntityRenderer<T> {
	...
	public void render(T entity, float entityYaw, float partialTicks, PoseStack stack, MultiBufferSource buffer, int light, int overlayTexture) {
		stack.pushPose();
