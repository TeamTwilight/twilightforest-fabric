...
public class BrazierModel extends Model {
	...
	public void renderToBuffer(PoseStack pose, VertexConsumer vc, int light, int overlay, int color) {
		this.leg1.render(pose, vc, light, overlay, color);
		this.leg2.render(pose, vc, light, overlay, color);
		this.leg3.render(pose, vc, light, overlay, color);
		this.leg4.render(pose, vc, light, overlay, color);
		this.basket.render(pose, vc, light, overlay, color);
		this.charcoal.render(pose, vc, light, overlay, color);
		this.rope.render(pose, vc, light, overlay, color);
	}
}
