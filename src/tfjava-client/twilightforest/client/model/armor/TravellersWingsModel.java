...
public class TravellersWingsModel extends HumanoidModel<LivingEntity> {
	...
	public void setupModelAnimations(LivingEntity entity, float f, float f1, double ageInTicks, float netHeadYaw, float headPitch) {
		...
		TravellersWingsAnimAttachment animAttachment = TFDataAttachments.get(entity, TFDataAttachments.TRAVELLERS_WINGS_ANIM);
		TravellersWingsAttachment attachment = TFDataAttachments.get(entity, TFDataAttachments.TRAVELLERS_WINGS);
