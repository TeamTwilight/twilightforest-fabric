...
/**
 * 1:1 port of upstream {@code twilightforest.entity.boss.bar.ClientTFBossBar} —
 * client-side {@link LerpingBossEvent} subclass that paints with an arbitrary
 * 24-bit RGB color via shader-color tint over the vanilla white boss-bar sprite.
 * Set color/setTime are mutated by {@code TFBossBarPacket.UpdateTFBossBarStylePacket}
 * receivers wired in {@code CodexNetworking} (client side).
 */
