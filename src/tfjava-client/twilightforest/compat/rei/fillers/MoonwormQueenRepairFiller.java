		...
		return List.of(
			new DefaultCustomShapelessDisplay(recipe,
				List.of(
					...
					EntryIngredient.of(EntryStack.of(BuiltinClientEntryTypes.RENDERING, EntryStack.of(VanillaEntryTypes.ITEM, new ItemStack(TFItems.TORCHBERRIES.get())))),
				...
				List.of(ofRendering(RecipeViewerConstants.MOONWORM_QUEEN_LIST), EntryIngredients.of(TFItems.MOONWORM_QUEEN.get()))));
	}
