...
public class TFREIClientPlugin implements REIClientPlugin {
	...
	public void registerDisplays(DisplayRegistry registry) {
		...
		if (!TFConfig.disableEntireTable) {
			registry.registerRecipeFiller(UncraftingRecipe.class, TFRecipes.UNCRAFTING_RECIPE, REIUncraftingDisplay::ofUncrafting);
		...
		registry.registerRecipeFiller(DryingRecipe.class, TFRecipes.DRYING_RECIPE, holder -> {
