...
public class EmiEmperorsClothRecipe extends EmiPatternCraftingRecipe {
	...
	public EmiEmperorsClothRecipe() {
		super(List.of(EmiIngredient.of(ARMORS), EmiStack.of(TFItems.EMPERORS_CLOTH.get())), EmiStack.EMPTY, BuiltInRegistries.RECIPE_SERIALIZER.getKey(TFRecipes.EMPERORS_CLOTH_RECIPE));
	}
	...
	public SlotWidget getInputWidget(int slot, int x, int y) {
		...
		if (slot == 1) {
			return new SlotWidget(EmiStack.of(TFItems.EMPERORS_CLOTH.get()), x, y);
		}
