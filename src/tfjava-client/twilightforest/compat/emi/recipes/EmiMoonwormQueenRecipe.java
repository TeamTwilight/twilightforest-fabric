...
public class EmiMoonwormQueenRecipe extends TFEmiRecipe<MoonwormQueenRepairRecipe> {
	...
	public EmiMoonwormQueenRecipe() {
		super(VanillaEmiRecipeCategories.CRAFTING, new RecipeHolder<>(BuiltInRegistries.RECIPE_SERIALIZER.getKey(TFRecipes.MOONWORM_QUEEN_REPAIR_RECIPE), new MoonwormQueenRepairRecipe(CraftingBookCategory.MISC)), TwilightForestMod.prefix("/moonworm_queen_repairing"), RecipeViewerConstants.GENERIC_RECIPE_WIDTH + 2, RecipeViewerConstants.GENERIC_RECIPE_HEIGHT);
	}

	@Override
	protected void addAdditionalInputs(List<EmiIngredient> inputs) {
		inputs.add(EmiStack.of(TFItems.MOONWORM_QUEEN.get()));
	}

	@Override
	protected void addAdditionalOutputs(List<EmiStack> outputs) {
		outputs.add(EmiStack.of(TFItems.MOONWORM_QUEEN.get()));
	}
	...
	public void addWidgets(WidgetHolder widgets) {
		...
		widgets.addSlot(EmiStack.of(TFItems.TORCHBERRIES.get()), 18, 0);
