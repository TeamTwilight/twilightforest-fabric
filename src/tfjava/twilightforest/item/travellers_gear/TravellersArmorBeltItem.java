...
public class TravellersArmorBeltItem extends TravellersArmorItem {
	...
	public static void travellersTrySwapHotbar(Player player) {
		...
		for (int slotIndex = 0; slotIndex < 9; slotIndex++) {
			...
			NonNullList<ItemStack> beltContents = NonNullList.withSize(9, ItemStack.EMPTY);
			containerContents.copyInto(beltContents);
			ItemStack beltStack = beltContents.get(slotIndex);
