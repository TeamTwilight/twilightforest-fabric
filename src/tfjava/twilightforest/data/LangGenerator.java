...
public class LangGenerator extends TFLangProvider {
	...
	private static final String TRAVELLERS_GEAR_KEY_CATEGORY = "key.twilightforest.categories.travellers_gear";
	private static final String RED_THREAD_VISION_KEY = "key.twilightforest.red_thread_vision";
	private static final String ITEM_DISPLAY_MAP_CYCLE_KEY = "key.twilightforest.item_display_map_cycle";
	private static final String ZOOM_KEY = "key.twilightforest.zoom";
	private static final String SWAP_HOTBAR_KEY = "key.twilightforest.swap_hotbar";
	...
	protected void addTranslations(HolderLookup.Provider registries) {
		...
		this.addBlock(TFBlocks.WITHER_SKELETON_SKULL_CANDLE, "Wither Skeleton Skull Candle");
		this.addBlock(TFBlocks.WITHER_SKELETON_WALL_SKULL_CANDLE, "Wither Skeleton Wall Skull Candle");
		...
		this.addItem(TFItems.LAMPOFCINDERS, "Lamp of Cinders");
		...
		this.add(TRAVELLERS_GEAR_KEY_CATEGORY, "Twilight Forest (Traveller's Gear)");

		this.add(RED_THREAD_VISION_KEY, "See Red Thread with Goggles");
		this.add(ITEM_DISPLAY_MAP_CYCLE_KEY, "Cycle Item Display's Stored Maps");
		this.add(ZOOM_KEY, "Zoom With Goggles");
		this.add(SWAP_HOTBAR_KEY, "Swap Hotbar");

		this.add("item.twilightforest.travellers_gloves.desc", "Cosmetic");

		// built-in modifiers
		this.addTravellersModifier(registries, TravellersModifiersManager.ZOOM_ABILITY, "Zoom (keybind: ${tfkeybinds/" + ZOOM_KEY + "})");
		this.addTravellersModifier(registries, TravellersModifiersManager.SWIFT_SWIM_ABILITY, "Swift Swim");
		this.addTravellersModifier(registries, TravellersModifiersManager.SWAP_HOTBAR_ABILITY, "Swap Hotbar (keybind: ${tfkeybinds/" + SWAP_HOTBAR_KEY + "})");
		...
		this.addTravellersModifier(registries, TravellersModifiersManager.RED_THREAD_VISION_MODIFIER, "Red Thread Vision (keybind: ${tfkeybinds/" + RED_THREAD_VISION_KEY + "})");
		...
		this.addTravellersModifier(registries, TravellersModifiersManager.ITEM_DISPLAY_MODIFIER, "Item Display (keybind: ${tfkeybinds/" + ITEM_DISPLAY_MAP_CYCLE_KEY + "})");
		...
		this.addTravellersModifier(registries, TravellersModifiersManager.SWAP_HOTBAR_MODIFIER, "Swap Hotbar (keybind: ${tfkeybinds/" + SWAP_HOTBAR_KEY + "})");
