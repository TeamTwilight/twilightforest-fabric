...
public class SkullCandleBlock extends AbstractSkullCandleBlock {
	...
	private static final Int2ObjectMap<List<Vec3>> PARTICLE_OFFSETS = Util.make(() -> {
		...
		map.put(1, ImmutableList.of(new Vec3(0.5D, 0.96D, 0.5D)));
		map.put(2, ImmutableList.of(new Vec3(0.375D, 0.88D, 0.5D), new Vec3(0.625D, 0.96D, 0.44D)));
		map.put(3, ImmutableList.of(new Vec3(0.5D, 0.73D, 0.625D), new Vec3(0.375D, 0.88D, 0.5D), new Vec3(0.56D, 0.96D, 0.44D)));
		map.put(4, ImmutableList.of(new Vec3(0.44D, 0.73D, 0.56D), new Vec3(0.625D, 0.88D, 0.56D), new Vec3(0.375D, 0.88D, 0.375D), new Vec3(0.56D, 0.96D, 0.375D)));
