...
/**
 * 1:1 port of upstream {@code twilightforest.block.MushgloomBlock}. NeoForge upstream
 * passes {@code TFConfiguredFeatures.BIG_MUSHGLOOM}; codex registers the same feature
 * under the name {@code TROLL_BIG_MUSHGLOOMS} so we wire that one in.
 */
public class MushgloomBlock extends MushroomBlock {
	...
	public MushgloomBlock(Properties properties) {
		super(TFConfiguredFeatures.TROLL_BIG_MUSHGLOOMS, properties);
	}
