...
/**
 * 1:1 port of upstream {@code twilightforest.block.HedgeBlock}.
 *
 * <p>Damages entities (cactus damage type) on contact, step, attack-by-player, and break.
 * Schedules a tick when attacked so swinging-at-distance pricks repeatedly. The {@code tick}
 * method ray-casts every nearby player who is currently swinging to find anyone aiming at
 * this block, mimicking upstream's "prick from a distance" sting behaviour.</p>
 *
 * <p>Codex Fabric port note: NF-only {@code Block#getBlockPathType} hook kept body 1:1
 * without {@code @Override} for future mixin/registry hookup.</p>
 */
