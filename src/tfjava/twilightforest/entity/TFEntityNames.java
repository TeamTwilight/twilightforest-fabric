...
/**
 * 1:1 port of upstream {@code twilightforest.entity.TFEntityNames}. Centralized table
 * of {@link ResourceLocation} ids referenced from both {@code TFEntities} registry
 * setup and entity-specific data (sounds, advancements, datapack lookups). Pure
 * constant table — no NeoForge symbols touched.
 */
