...
/**
 * 1:1 port of upstream {@code twilightforest.entity.ai.control.NoClipMoveControl} —
 * MoveControl that ignores collision and just nudges deltaMovement toward the
 * target every few ticks. Used by phasing/flying boss minions.
 */
