...
/**
 * 1:1 port of upstream {@code twilightforest.entity.ai.goal.AvoidAnyEntityGoal}.
 * VanillaCopy of AvoidEntityGoal, hacked together with the 1.12 EntityAIAvoidEntity
 * so any Entity (not just LivingEntity) can be avoided — used for fleeing from
 * non-living projectiles/objects.
 */
