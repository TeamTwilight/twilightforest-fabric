...
/**
 * 1:1 port of upstream {@code twilightforest.entity.ai.goal.FlockToSameKindGoal} —
 * mob steers toward the centroid of nearby same-class members when the flock is
 * sparse but reachable. Pacifies kobolds holding the
 * {@link ItemTagGenerator#KOBOLD_PACIFICATION_BREADS} tagged item.
 */
