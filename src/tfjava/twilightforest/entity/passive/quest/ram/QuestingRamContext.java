...
/**
 * 1:1 port of upstream {@code twilightforest.entity.passive.quest.ram.QuestingRamContext}.
 * Datapack-driven record describing the wool requirements + reward loot table for
 * the Questing Ram. Validated to require all 16 dye colors before being applied.
 */
