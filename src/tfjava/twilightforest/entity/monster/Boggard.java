...
/**
 * 1:1 port of upstream {@code twilightforest.entity.monster.Boggard} — Hollow
 * Hill mid-tier melee with a 1.5× charge attack and Redcap-flavoured ambient/hurt
 * sounds.
 *
 * <p>Codex Fabric port note: {@code TFSounds.X.get()} → {@code TFSounds.X} (codex
 * returns {@code SoundEvent} directly).</p>
 */
