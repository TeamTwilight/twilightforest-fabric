...
/**
 * 1:1 port of upstream {@code twilightforest.entity.projectile.SeekerArrow} — TFArrow
 * subclass that auto-curves toward a chosen living-entity target each tick. Picks
 * the nearest visible non-tamed monster (preferring those targeting the shooter)
 * inside a directional cone.
 */
