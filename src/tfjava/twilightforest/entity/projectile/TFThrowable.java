...
/**
 * 1:1 port of upstream {@code twilightforest.entity.projectile.TFThrowable} —
 * generic ThrowableProjectile parent with a particle-trail helper that TF
 * thrown projectiles use for visual trails (slime, ice, weapon spin).
 */
