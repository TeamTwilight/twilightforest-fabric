...
/**
 * 1:1 port of upstream {@code twilightforest.entity.ProtectionBox} — invisible
 * client-side bounding-box marker entity that highlights an unbreakable boss-room
 * zone. Auto-discards after 60 ticks if not refreshed by the structure-aware
 * mixin/event hook.
 */
