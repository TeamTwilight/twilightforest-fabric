...
public class TConCompat extends TFCompat {
	...
	public static void tConDatagen(FabricDataGenerator generator) {
		generator.addProvider(new TConDataGenerator.TConFluidTagGenerator(generator));
	...
	public static final FluidObject<SimpleFlowableFluid> MOLTEN_KNIGHTMETAL = FLUIDS.register("molten_knightmetal", ModelFluidAttributes.builder().temperature(1000).luminosity(15).sound(SoundEvents.BUCKET_FILL_LAVA, SoundEvents.BUCKET_EMPTY_LAVA), Material.LAVA, 15);
	public static final FluidObject<SimpleFlowableFluid> MOLTEN_FIERY = FLUIDS.register("molten_fiery", ModelFluidAttributes.builder().temperature(1000).luminosity(15).sound(SoundEvents.BUCKET_FILL_LAVA, SoundEvents.BUCKET_EMPTY_LAVA), Material.LAVA, 15);
	public static final FluidObject<SimpleFlowableFluid> FIERY_ESSENCE = FLUIDS.register("fiery_essence", ModelFluidAttributes.builder().temperature(1000).sound(SoundEvents.BUCKET_FILL_LAVA, SoundEvents.BUCKET_EMPTY_LAVA), Material.LAVA, 0);
