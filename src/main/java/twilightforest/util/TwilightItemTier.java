...
public class TwilightItemTier {
	...
	public static final Tier IRONWOOD = TierSortingRegistry.registerTier(
			new LazyTier(2, 512, 6.5F, 2, 25, TagKey.create(Registry.BLOCK_REGISTRY, TwilightForestMod.prefix("needs_ironwood_tool")), () -> Ingredient.of(TFItems.IRONWOOD_INGOT.get())),
	...
	public static final Tier ICE = TierSortingRegistry.registerTier(
			new LazyTier(0, 32, 1.0F, 3.5F, 5, TagKey.create(Registry.BLOCK_REGISTRY, TwilightForestMod.prefix("needs_ice_tool")), () -> Ingredient.of(Blocks.PACKED_ICE)),
			TwilightForestMod.prefix("ice"), List.of(), List.of(Tiers.WOOD));

	public static final Tier GLASS = TierSortingRegistry.registerTier(
			new LazyTier(0, 1, 1.0F, 36.0F, 30, TagKey.create(Registry.BLOCK_REGISTRY, TwilightForestMod.prefix("needs_glass_tool")), () -> Ingredient.EMPTY),
