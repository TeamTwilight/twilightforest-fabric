...
public class TFWoodTypes {
	...
	public static final WoodType DARK_WOOD_TYPE = WoodTypeRegistry.register(TwilightForestMod.prefix("dark"), DARK_WOOD_SET);
	public static final WoodType TIME_WOOD_TYPE = WoodTypeRegistry.register(TwilightForestMod.prefix("time"), TIME_WOOD_SET);
