...
public class TFTileEntities {
	...
	public static final BlockEntityType<SkullCandleTileEntity> SKULL_CANDLE = Registry.register(Registry.BLOCK_ENTITY_TYPE, TwilightForestMod.ID+":skull_candle",
	...
	public static final BlockEntityType<TomeSpawnerTileEntity> TOME_SPAWNER = Registry.register(Registry.BLOCK_ENTITY_TYPE, TwilightForestMod.ID+":tome_spawner",
