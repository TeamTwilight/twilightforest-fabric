...
public class TFItems {
	...
	public static final Item music_disc_radiance = Registry.register(Registry.ITEM, TFConstants.ID + ":music_disc_radiance", new RecordItem(15, TFSounds.MUSIC_DISC_RADIANCE, defaultBuilder().stacksTo(1).rarity(Rarity.RARE)));
	public static final Item music_disc_steps = Registry.register(Registry.ITEM, TFConstants.ID + ":music_disc_steps", new RecordItem(15, TFSounds.MUSIC_DISC_STEPS, defaultBuilder().stacksTo(1).rarity(Rarity.RARE)));
	public static final Item music_disc_superstitious = Registry.register(Registry.ITEM, TFConstants.ID + ":music_disc_superstitious", new RecordItem(15, TFSounds.MUSIC_DISC_SUPERSTITIOUS, defaultBuilder().stacksTo(1).rarity(Rarity.RARE)));
	public static final Item music_disc_home = Registry.register(Registry.ITEM, TFConstants.ID + ":music_disc_home", new RecordItem(15, TFSounds.MUSIC_DISC_HOME, defaultBuilder().stacksTo(1).rarity(Rarity.RARE)));
	public static final Item music_disc_wayfarer = Registry.register(Registry.ITEM, TFConstants.ID + ":music_disc_wayfarer", new RecordItem(15, TFSounds.MUSIC_DISC_WAYFARER, defaultBuilder().stacksTo(1).rarity(Rarity.RARE)));
	public static final Item music_disc_findings = Registry.register(Registry.ITEM, TFConstants.ID + ":music_disc_findings", new RecordItem(15, TFSounds.MUSIC_DISC_FINDINGS, defaultBuilder().stacksTo(1).rarity(Rarity.RARE)));
	public static final Item music_disc_maker = Registry.register(Registry.ITEM, TFConstants.ID + ":music_disc_maker", new RecordItem(15, TFSounds.MUSIC_DISC_MAKER, defaultBuilder().stacksTo(1).rarity(Rarity.RARE)));
	public static final Item music_disc_thread = Registry.register(Registry.ITEM, TFConstants.ID + ":music_disc_thread", new RecordItem(15, TFSounds.MUSIC_DISC_THREAD, defaultBuilder().stacksTo(1).rarity(Rarity.RARE)));
	public static final Item music_disc_motion = Registry.register(Registry.ITEM, TFConstants.ID + ":music_disc_motion", new RecordItem(15, TFSounds.MUSIC_DISC_MOTION, defaultBuilder().stacksTo(1).rarity(Rarity.RARE)));
