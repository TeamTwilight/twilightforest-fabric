...
public record TransferableComponentModifier(
	...
	public boolean transfer(ItemStack output, CraftingInput input) {
		...
		if (dataComponentProviders.size() > 1) {
			TFCommon.LOGGER.error("A recipe with more than 2 dataComponentProviders was matched: {}. Please report to https://github.com/TeamTwilight/twilightforest/issues", input);
			return false;
		}
