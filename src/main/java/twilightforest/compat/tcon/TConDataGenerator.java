...
public class TConDataGenerator {
	...
	public static class TConFluidTagGenerator extends FluidTagsProvider {
		...
		public TConFluidTagGenerator(FabricDataGenerator generator) {
			super(generator);
		}
	...
	public static class TFMaterialRecipes extends BaseRecipeProvider implements IMaterialRecipeHelper {
		...
		public TFMaterialRecipes(FabricDataGenerator generator) {
			super(generator);
		}

		@Override
		protected void generateRecipes(Consumer<FinishedRecipe> consumer) {
			materialMeltingCasting(withCondition(consumer, DefaultResourceConditions.allModsLoaded(TFCompat.TCON_ID)), TConCompat.FIERY, TConCompat.MOLTEN_FIERY, true, "tools/materials/");
			materialMeltingCasting(withCondition(consumer, DefaultResourceConditions.allModsLoaded(TFCompat.TCON_ID)), TConCompat.KNIGHTMETAL, TConCompat.MOLTEN_KNIGHTMETAL, true, "tools/materials/");

			metalMaterialRecipe(withCondition(consumer, DefaultResourceConditions.allModsLoaded(TFCompat.TCON_ID)), TConCompat.FIERY, "tools/materials/", "fiery", false);
			metalMaterialRecipe(withCondition(consumer, DefaultResourceConditions.allModsLoaded(TFCompat.TCON_ID)), TConCompat.KNIGHTMETAL, "tools/materials/", "knightmetal", false);
			materialRecipe(withCondition(consumer, DefaultResourceConditions.allModsLoaded(TFCompat.TCON_ID)), TConCompat.NAGASCALE, Ingredient.of(TFItems.NAGA_SCALE.get()), 1, 1, "tools/materials/nagascale");
			materialRecipe(withCondition(consumer, DefaultResourceConditions.allModsLoaded(TFCompat.TCON_ID)), TConCompat.STEELEAF, Ingredient.of(ItemTagGenerator.STEELEAF_INGOTS), 1, 1, "tools/materials/steeleaf");
		}
	...
	public static class TFSmelteryRecipes extends BaseRecipeProvider implements ISmelteryRecipeHelper, ICommonRecipeHelper {
		...
		public TFSmelteryRecipes(FabricDataGenerator generator) {
			super(generator);
		}

		@Override
		protected void generateRecipes(Consumer<FinishedRecipe> consumer) {
			this.metalTagCasting(withCondition(consumer, DefaultResourceConditions.allModsLoaded(TFCompat.TCON_ID)), TConCompat.MOLTEN_KNIGHTMETAL, "knightmetal", "smeltery/casting/metal/", true);
			this.metalMelting(withCondition(consumer, DefaultResourceConditions.allModsLoaded(TFCompat.TCON_ID)), TConCompat.MOLTEN_KNIGHTMETAL.get(), "knightmetal", false, "smeltery/melting/metal", false);
			this.metalTagCasting(withCondition(consumer, DefaultResourceConditions.allModsLoaded(TFCompat.TCON_ID)), TConCompat.MOLTEN_FIERY, "fiery", "smeltery/casting/metal/", true);
			this.metalMelting(withCondition(consumer, DefaultResourceConditions.allModsLoaded(TFCompat.TCON_ID)), TConCompat.MOLTEN_FIERY.get(), "fiery", false, "smeltery/melting/metal", false);

			MeltingFuelBuilder.fuel(new FluidStack(TConCompat.FIERY_ESSENCE.get(), 50 * 81), 300)
					.save(withCondition(consumer, DefaultResourceConditions.allModsLoaded(TFCompat.TCON_ID)), modResource("smeltery/melting/fuel/fiery_essence"));
		}
