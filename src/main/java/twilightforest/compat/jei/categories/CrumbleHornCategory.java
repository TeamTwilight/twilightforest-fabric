...
public class CrumbleHornCategory implements IRecipeCategory<CrumbleRecipe> {
	...
	public static final IRecipeType<CrumbleRecipe> CRUMBLE_HORN = IRecipeType.create(TFCommon.ID, "crumble_horn", CrumbleRecipe.class);
	...
	public CrumbleHornCategory(IGuiHelper helper) {
		...
		this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, TFItems.CRUMBLE_HORN.getDefaultInstance());
