...
public class EMITransformationRecipe extends TFEmiRecipe<TransformPowderRecipe> {
	...
	public static final EmiTexture BACKGROUND = new EmiTexture(TEXTURES, 1, 4, WIDTH, HEIGHT);
	...
	public void addWidgets(WidgetHolder widgets) {
		...
		widgets.add(new EMIEntityWidget(recipe.input(), 7, 7, 32));
		widgets.addSlot(POWDER, 48, 2).drawBack(false);
		widgets.addTexture(arrow, 45, 15);
		widgets.add(new EMIEntityWidget(recipe.result(), 75, 7, 32));
	}
}
