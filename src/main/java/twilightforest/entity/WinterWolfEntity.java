...
public class WinterWolfEntity extends HostileWolfEntity implements IBreathAttacker {
	...
	private static final EntityDataAccessor<Boolean> BREATH_FLAG = SynchedEntityData.defineId(WinterWolfEntity.class, EntityDataSerializers.BOOLEAN);
	private static final float BREATH_DAMAGE = 2.0F;

	public WinterWolfEntity(EntityType<? extends WinterWolfEntity> type, Level world) {
		super(type, world);
	...
	public static boolean canSpawnHere(EntityType<? extends WinterWolfEntity> entity, ServerLevelAccessor world, MobSpawnType reason, BlockPos pos, Random random) {
