...
public class FallingIceEntity extends FallingBlockEntity {
	...
	public FallingIceEntity(EntityType<? extends FallingIceEntity> type, Level world) {
	...
	public void tick() {
		...
		if (!this.level.isClientSide) {
			List<FallingIceEntity> nearby = this.level.getEntitiesOfClass(FallingIceEntity.class, this.getBoundingBox());
