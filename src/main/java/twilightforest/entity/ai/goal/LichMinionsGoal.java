...
public class LichMinionsGoal extends Goal {
	...
	private void spawnMinionAt() {
		...
		if (minionSpot != null && this.lich.getLevel() instanceof ServerLevelAccessor accessor) {
			...
			PortingHooks.onFinalizeSpawn(minion, accessor, this.lich.getLevel().getCurrentDifficultyAt(BlockPos.containing(minionSpot)), MobSpawnType.MOB_SUMMONED, null, null);
