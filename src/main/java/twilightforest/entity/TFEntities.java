...
public class TFEntities {
	...
	public static final RegistryObject<EntityType<DeathTome>> DEATH_TOME = make(TFEntityNames.DEATH_TOME, DeathTome::new, MobCategory.MONSTER, 0.6F, 1.8F, 0x774e22, 0xdbcdbe);
	...
	public static final RegistryObject<EntityType<FallingIce>> FALLING_ICE = make(TFEntityNames.FALLING_ICE, FallingIce::new, MobCategory.MISC, 2.98F, 2.98F, true,0, 0);
	...
	public static void addEntityAttributes() {
		...
		//FabricDefaultAttributeRegistry.register(CASTLE_GUARDIAN.get(), Mob.createMobAttributes().create());
	...
	public static void registerEntityRenderer() {
		...
		EntityRendererRegistry.register(MOSQUITO_SWARM.get(), m -> new TFGenericMobRenderer<>(m, new MosquitoSwarmModel(m.bakeLayer(TFModelLayers.MOSQUITO_SWARM)), 0.0F, "mosquitoswarm.png"));
		...
		//EntityRendererRegistry.register(CASTLE_GUARDIAN.get(), m -> new RenderTFCastleGuardian(m, new ModelTFCastleGuardian(), 2.0F, "finalcastle/castle_guardian.png"));
