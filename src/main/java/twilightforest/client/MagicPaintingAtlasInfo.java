...
public class MagicPaintingAtlasInfo {
	...
	public static final Identifier ATLAS_LOCATION = TFMain.prefix("textures/atlas/magic_paintings.png");
	public static final Identifier ATLAS_INFO_LOCATION = Identifier.withDefaultNamespace(MAGIC_PAINTING_PATH);
	public static final Identifier BACK_SPRITE_LOCATION = TFMain.prefix(MAGIC_PAINTING_PATH + "/back");
}