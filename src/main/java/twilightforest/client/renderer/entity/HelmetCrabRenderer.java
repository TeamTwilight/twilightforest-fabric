...
public class HelmetCrabRenderer extends MobRenderer<HelmetCrab, HelmetCrabRenderState, HelmetCrabModel> {
	public static final Identifier TEXTURE = TFCommon.getModelTexture("helmetcrab.png");
	public static final Identifier BLUE_TEXTURE = TFCommon.getModelTexture("helmetcrabblue.png");
