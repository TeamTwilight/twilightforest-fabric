...
public class UrGhastRenderer extends MobRenderer<UrGhast, TFGhastRenderState, UrGhastModel> {
	...
	public static final Identifier TEXTURE = TFCommon.getModelTexture("towerboss.png");
	public static final Identifier LOOKING_TEXTURE = TFCommon.getModelTexture("towerboss_openeyes.png");
	public static final Identifier ATTACKING_TEXTURE = TFCommon.getModelTexture("towerboss_fire.png");
