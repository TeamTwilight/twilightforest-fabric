...
public class LichRenderer extends HumanoidMobRenderer<Lich, LichRenderState, LichModel> {
	...
	public static final Identifier TEXTURE = TFCommon.getModelTexture("twilightlich64.png");
	...
	public LichRenderer(EntityRendererProvider.Context context) {
		...
		this.addLayer(new EyesLayer<>(this) {
			private static final RenderType EYES = RenderTypes.eyes(TFCommon.getModelTexture("twilightlich64_eyes.png"));
