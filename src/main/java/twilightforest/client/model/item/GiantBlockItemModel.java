...
/**
 * Item model for giant blocks.
 * GUI: renders using the JSON model's element definitions (3D cube with 4x4 zoomed UVs).
 * Other perspectives: delegates to the wrapped model with display transforms.
 */
public class GiantBlockItemModel extends ForwardingBakedModel implements TransformTypeDependentItemBakedModel {

	public GiantBlockItemModel(BakedModel originalModel) {
	...
	// emitItemQuads: delegated to wrapped model (JSON model with 3D cube + zoomed UVs)
}