...
/**
 * Wraps the baked experiment 115 block model and re-emits its quads through the
 * Fabric Renderer API so that the sprinkle layer ({@code experiment115_sprinkle})
 ...
 */
public class Experiment115Model extends ForwardingBakedModel {
	...
	public Experiment115Model(BakedModel wrapped, ResourceLocation glowTexture) {
	...
	private void emit(QuadEmitter emitter, BakedQuad quad) {
		...
		// The sprinkle layer is a zero-orientation quad on top of the cake; never
		// cull it against neighboring blocks.
