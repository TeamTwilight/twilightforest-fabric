...
public class QuestGrove extends TwilightTemplateStructurePiece {
	...
	public QuestGrove(StructureTemplateManager structureManager, BlockPos templatePosition) {
		super(TFStructurePieceTypes.TFQuestGrove, 0, structureManager, TFCommon.prefix("quest_grove"), makeSettings(Rotation.NONE).addProcessor(MOSSY_BRICK_DECAY).addProcessor(StoneBricksVariants.INSTANCE), templatePosition);
	}
