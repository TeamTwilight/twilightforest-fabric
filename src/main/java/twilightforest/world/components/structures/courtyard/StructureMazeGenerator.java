					...
					switch (maze[x][y] & 0b1111) { // These are inconsistent because I was stupid with the structures I saved to .nbt
						...
						default:
							if (random.nextInt(150) == 0) {
								structure = new CourtyardTerrace(maze[x][y], xBB - 6, yBB - 3, zBB - 6, Rotation.NONE, this.structureManager, TFCommon.prefix("courtyard/terrace_statue"));
							} else {
								structure = switch (random.nextInt(5)) {
									case 1 -> new CourtyardTerrace(maze[x][y], xBB - 6, yBB - 3, zBB - 6, Rotation.NONE, this.structureManager, TFCommon.prefix("courtyard/terrace_duct"));
									case 2 -> new CourtyardTerrace(maze[x][y], xBB - 6, yBB - 3, zBB - 6, Rotation.NONE, this.structureManager, TFCommon.prefix("courtyard/terrace_channel"));
									case 3 -> new CourtyardTerrace(maze[x][y], xBB - 6, yBB - 3, zBB - 6, Rotation.NONE, this.structureManager, TFCommon.prefix("courtyard/terrace_reservoir"));
									case 4 -> new CourtyardTerraceHedge(maze[x][y], xBB - 6, yBB - 3, zBB - 6, Rotation.NONE, this.structureManager);
									default -> new CourtyardTerrace(maze[x][y], xBB - 6, yBB - 3, zBB - 6, Rotation.NONE, this.structureManager, TFCommon.prefix("courtyard/terrace_fire"));
								};
							}
