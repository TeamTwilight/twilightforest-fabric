...
public class FinalCastleMainComponent extends TFStructureComponentOld {
	...
	public void addChildren(StructurePiece parent, StructurePieceAccessor list, Random rand) {
		...
		buildTowerMaze(list, rand, 48, 0, 24, 60, Direction.SOUTH, TFBlocks.castle_rune_brick_pink.defaultBlockState(), dest);
		...
		buildTowerMaze(list, rand, 0, 30, 24, 60, Direction.NORTH, TFBlocks.castle_rune_brick_blue.defaultBlockState(), dest);
	...
	private boolean isMazeComplete(StructurePieceAccessor list, BlockState type) {
		if (list instanceof StructureStart<?> start) {
			...
			for (StructurePiece structurecomponent : start.getPieces()) {
				...
				if (type == TFBlocks.castle_rune_brick_pink.defaultBlockState() && structurecomponent instanceof FinalCastleEntranceTowerComponent) {
					return true;
				}
				if (type == TFBlocks.castle_rune_brick_blue.defaultBlockState() && structurecomponent instanceof FinalCastleBellTower21Component) {
					return true;
				}
			}
		}
	...
	public boolean postProcess(WorldGenLevel world, StructureFeatureManager manager, ChunkGenerator generator, Random rand, BoundingBox sbb, ChunkPos chunkPosIn, BlockPos blockPos) {
		...
		BlockState fieldBlock = TFBlocks.force_field_pink.defaultBlockState();
		...
		this.generateBox(world, sbb, 17, 1, 12, 19, 4, 12, TFBlocks.castle_door_pink.defaultBlockState(), AIR, false);
		this.generateBox(world, sbb, 17, 1, 24, 19, 4, 24, TFBlocks.castle_door_pink.defaultBlockState(), AIR, false);
		...
		// door, first floor
		this.generateBox(world, sbb, 48, 1, 23, 48, 4, 25, TFBlocks.castle_door_yellow.defaultBlockState(), AIR, false);

		// door, second floor
		this.generateBox(world, sbb, 0, 31, 23, 0, 34, 25, TFBlocks.castle_door_purple.defaultBlockState(), AIR, false);
