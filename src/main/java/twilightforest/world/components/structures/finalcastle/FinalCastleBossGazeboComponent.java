...
public class FinalCastleBossGazeboComponent extends TFStructureComponentOld {
	...
	public void addChildren(StructurePiece parent, StructurePieceAccessor list, RandomSource rand) {
		...
		TwilightJigsawPiece templatePiece = TwilightJigsawPiece.initializeTemplateFromPool(GAZEBO_TEMP_POOL, this.getWorldPos(10, -1, 10), FrontAndTop.UP_SOUTH, "twilightforest:final_castle/final_boss", rand, this.genDepth + 1, ServerLifecycleHooks.getCurrentServer().getStructureManager());
