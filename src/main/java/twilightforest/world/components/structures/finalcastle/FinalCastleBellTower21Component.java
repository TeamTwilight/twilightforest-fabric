...
public class FinalCastleBellTower21Component extends FinalCastleMazeTower13Component {
	...
	public FinalCastleBellTower21Component(TFFeature feature, Random rand, int i, int x, int y, int z, Direction direction) {
		super(FinalCastlePieces.TFFCBelTo, feature, rand, i, x, y, z, FLOORS, 1, TFBlocks.castle_rune_brick_blue.defaultBlockState(), direction);
		this.size = 21;
		int floors = FLOORS;
	...
	public boolean postProcess(WorldGenLevel world, StructureFeatureManager manager, ChunkGenerator generator, Random rand, BoundingBox sbb, ChunkPos chunkPosIn, BlockPos blockPos) {
		...
		// openings!
		BlockState fieldBlock = TFBlocks.force_field_blue.defaultBlockState();
