...
public interface ControlledSpawns {
	...
	record ControlledSpawningConfig(Map<String, List<MobSpawnSettings.SpawnerData>> spawnableMonsterLists,
									List<MobSpawnSettings.SpawnerData> ambientCreatureList,
									List<MobSpawnSettings.SpawnerData> waterCreatureList,
									List<MobSpawnSettings.SpawnerData> combinedMonsterSpawnableCache,
									List<MobSpawnSettings.SpawnerData> combinedCreatureSpawnableCache) {
