...
public class MazeCorridorIronFenceComponent extends MazeCorridorComponent {
	...
	public boolean postProcess(WorldGenLevel world, StructureFeatureManager manager, ChunkGenerator generator, Random rand, BoundingBox sbb, ChunkPos chunkPosIn, BlockPos blockPos) {
		this.generateBox(world, sbb, 1, 4, 2, 4, 4, 3, TFBlocks.maze_stone_decorative.defaultBlockState(), AIR, false);
		this.generateBox(world, sbb, 1, 1, 2, 4, 3, 3, TFBlocks.maze_stone_chiseled.defaultBlockState(), AIR, false);
