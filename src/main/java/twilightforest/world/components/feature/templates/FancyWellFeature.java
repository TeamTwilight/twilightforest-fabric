...
public class FancyWellFeature extends TemplateFeature<SwizzleConfig> {
	...
	private static final Identifier WELL_TOP = TFCommon.prefix("feature/well/fancy_well_top");
	private static final Identifier WELL_BOTTOM = TFCommon.prefix("feature/well/fancy_well_bottom");
