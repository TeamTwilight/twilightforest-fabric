...
public class TFGenerationSettings /*extends GenerationSettings*/ {
	...
	public static boolean isStrictlyTwilightForest(Level world) {
		return world.dimension().location().toString().equals(TwilightForestMod.COMMON_CONFIG.dimension.portal_destination_id);
	}
	...
	public static boolean isBiomeSafeFor(Biome biome, Entity entity) {
		ResourceLocation[] advancements = BIOME_ADVANCEMENTS.get(entity.level.registryAccess().registryOrThrow(Registry.BIOME_REGISTRY).getKey(biome));
