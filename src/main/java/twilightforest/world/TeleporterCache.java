...
public class TeleporterCache extends SavedData {
	...
	public static final SavedDataType<TeleporterCache> TELEPORTER_CACHE_TYPE = new SavedDataType<>(TFCommon.prefix("teleporter_cache"), TeleporterCache::new, CODEC, null);
