...
//		tintedAndFlipped(TFBlocks.tower_wood);
//		simpleBlock(TFBlocks.tower_wood_encased, cubeAllTinted(TFBlocks.tower_wood_encased.getId().getPath(), TFBlocks.tower_wood_encased.getId().getPath()));
//		simpleBlock(TFBlocks.tower_wood_cracked, ConfiguredModel.builder()
...
//		);
//		tintedAndFlipped(TFBlocks.tower_wood_mossy);
//		tintedAndFlipped(TFBlocks.tower_wood_infested);
//
//		builtinEntity(TFBlocks.firefly, "twilightforest:block/stone_twist/twist_blank");
//		builtinEntity(TFBlocks.moonworm, "twilightforest:block/stone_twist/twist_blank");
//		builtinEntity(TFBlocks.cicada, "twilightforest:block/stone_twist/twist_blank");
//
...
//		getMultipartBuilder(TFBlocks.twilight_portal)
...
//
//		getVariantBuilder(TFBlocks.experiment_115).forAllStates(state -> {
...
//		});
//
//		MultiPartBlockStateBuilder ironLadder = getMultipartBuilder(TFBlocks.iron_ladder);
...
//		towerBlocks();
//
//		simpleBlock(TFBlocks.fake_gold, models().getExistingFile(new ResourceLocation("block/gold_block")));
//		simpleBlock(TFBlocks.fake_diamond, models().getExistingFile(new ResourceLocation("block/diamond_block")));
//
//		simpleBlock(TFBlocks.naga_trophy, models().getExistingFile(new ResourceLocation("block/skull")));
//		simpleBlock(TFBlocks.lich_trophy, models().getExistingFile(new ResourceLocation("block/skull")));
//		simpleBlock(TFBlocks.minoshroom_trophy, models().getExistingFile(new ResourceLocation("block/skull")));
//		simpleBlock(TFBlocks.hydra_trophy, models().getExistingFile(new ResourceLocation("block/skull")));
//		simpleBlock(TFBlocks.yeti_trophy, models().getExistingFile(new ResourceLocation("block/skull")));
//		simpleBlock(TFBlocks.snow_queen_trophy, models().getExistingFile(new ResourceLocation("block/skull")));
//		simpleBlock(TFBlocks.knight_phantom_trophy, models().getExistingFile(new ResourceLocation("block/skull")));
//		simpleBlock(TFBlocks.ur_ghast_trophy, models().getExistingFile(new ResourceLocation("block/skull")));
//		simpleBlock(TFBlocks.quest_ram_trophy, models().getExistingFile(new ResourceLocation("block/skull")));
//		simpleBlock(TFBlocks.naga_wall_trophy, models().getExistingFile(new ResourceLocation("block/skull")));
//        simpleBlock(TFBlocks.lich_wall_trophy, models().getExistingFile(new ResourceLocation("block/skull")));
//        simpleBlock(TFBlocks.minoshroom_wall_trophy, models().getExistingFile(new ResourceLocation("block/skull")));
//        simpleBlock(TFBlocks.hydra_wall_trophy, models().getExistingFile(new ResourceLocation("block/skull")));
//		simpleBlock(TFBlocks.yeti_wall_trophy, models().getExistingFile(new ResourceLocation("block/skull")));
//        simpleBlock(TFBlocks.snow_queen_wall_trophy, models().getExistingFile(new ResourceLocation("block/skull")));
//        simpleBlock(TFBlocks.knight_phantom_wall_trophy, models().getExistingFile(new ResourceLocation("block/skull")));
//        simpleBlock(TFBlocks.ur_ghast_wall_trophy, models().getExistingFile(new ResourceLocation("block/skull")));
//        simpleBlock(TFBlocks.quest_ram_wall_trophy, models().getExistingFile(new ResourceLocation("block/skull")));
//
//		simpleBlock(TFBlocks.zombie_skull_candle, models().getExistingFile(new ResourceLocation("block/skull")));
//		simpleBlock(TFBlocks.zombie_wall_skull_candle, models().getExistingFile(new ResourceLocation("block/skull")));
//		simpleBlock(TFBlocks.skeleton_skull_candle, models().getExistingFile(new ResourceLocation("block/skull")));
//		simpleBlock(TFBlocks.skeleton_wall_skull_candle, models().getExistingFile(new ResourceLocation("block/skull")));
//		simpleBlock(TFBlocks.wither_skele_skull_candle, models().getExistingFile(new ResourceLocation("block/skull")));
//		simpleBlock(TFBlocks.wither_skele_wall_skull_candle, models().getExistingFile(new ResourceLocation("block/skull")));
//		simpleBlock(TFBlocks.creeper_skull_candle, models().getExistingFile(new ResourceLocation("block/skull")));
//		simpleBlock(TFBlocks.creeper_wall_skull_candle, models().getExistingFile(new ResourceLocation("block/skull")));
//		simpleBlock(TFBlocks.player_skull_candle, models().getExistingFile(new ResourceLocation("block/skull")));
//		simpleBlock(TFBlocks.player_wall_skull_candle, models().getExistingFile(new ResourceLocation("block/skull")));
//
...
//		getVariantBuilder(TFBlocks.stronghold_shield)
//						.forAllStates(state -> {
...
//		auroraBlocks();
//		slider();
//		simpleBlock(TFBlocks.underbrick);
//		simpleBlock(TFBlocks.underbrick_cracked);
//		simpleBlock(TFBlocks.underbrick_mossy);
//		simpleBlock(TFBlocks.underbrick_floor);
//		thorns();
//		simpleBlock(TFBlocks.thorn_rose, models().cross(TFBlocks.thorn_rose.getId().getPath(), blockTexture(TFBlocks.thorn_rose)));
//		simpleBlock(TFBlocks.thorn_leaves, models().getExistingFile(new ResourceLocation("block/oak_leaves")));
//		simpleBlock(TFBlocks.beanstalk_leaves, models().getExistingFile(new ResourceLocation("block/spruce_leaves")));
//		simpleBlock(TFBlocks.hollow_oak_sapling, models().cross(TFBlocks.hollow_oak_sapling.getId().getPath(), blockTexture(TFBlocks.hollow_oak_sapling)));
//		ModelFile deadrock = models().cubeAll(TFBlocks.deadrock.getId().getPath(), blockTexture(TFBlocks.deadrock));
...
//						.texture("all", blockTexture(TFBlocks.deadrock));
//		simpleBlock(TFBlocks.deadrock, ConfiguredModel.builder()
...
//		);
//		ModelFile deadrockCracked = models().cubeAll(TFBlocks.deadrock_cracked.getId().getPath(), blockTexture(TFBlocks.deadrock_cracked));
//		allRotations(TFBlocks.deadrock_cracked, deadrockCracked);
//		ModelFile deadrockWeathered = models().cubeAll(TFBlocks.deadrock_weathered.getId().getPath(), blockTexture(TFBlocks.deadrock_weathered));
//		allRotations(TFBlocks.deadrock_weathered, deadrockWeathered);
//		perFaceBlock(TFBlocks.trollsteinn, blockTexture(TFBlocks.trollsteinn), prefix("block/" + TFBlocks.trollsteinn.getId().getPath() + "_light"));
//		simpleBlock(TFBlocks.wispy_cloud);
//		simpleBlock(TFBlocks.fluffy_cloud);
//		simpleBlock(TFBlocks.giant_cobblestone, models().withExistingParent(TFBlocks.giant_cobblestone.getId().getPath(), prefix("block/util/giant_block"))
//						.texture("all", blockTexture(Blocks.COBBLESTONE)));
//		simpleBlock(TFBlocks.giant_log, models().withExistingParent(TFBlocks.giant_log.getId().getPath(), prefix("block/util/giant_column"))
//						.texture("side", blockTexture(Blocks.OAK_LOG))
//						.texture("end", new ResourceLocation("block/oak_log_top")));
//		simpleBlock(TFBlocks.giant_leaves, models().withExistingParent(TFBlocks.giant_leaves.getId().getPath(), prefix("block/util/giant_block"))
//						.texture("all", blockTexture(Blocks.OAK_LEAVES)));
//		simpleBlock(TFBlocks.giant_obsidian, models().withExistingParent(TFBlocks.giant_obsidian.getId().getPath(), prefix("block/util/giant_block"))
//						.texture("all", blockTexture(Blocks.OBSIDIAN)));
//		simpleBlock(TFBlocks.uberous_soil, models().withExistingParent(TFBlocks.uberous_soil.getId().getPath(), prefix("block/util/cube_all_2_layer"))
//						.texture("all", blockTexture(TFBlocks.uberous_soil))
//						.texture("all2", prefix("block/" + TFBlocks.uberous_soil.getId().getPath() + "_glow")));
//		simpleBlock(TFBlocks.huge_stalk, models().cubeColumn(TFBlocks.huge_stalk.getId().getPath(),
//						prefix("block/" + TFBlocks.huge_stalk.getId().getPath()),
//						prefix("block/" + TFBlocks.huge_stalk.getId().getPath() + "_top")));
//		perFaceBlock(TFBlocks.huge_mushgloom, prefix("block/huge_gloom_inside"), prefix("block/huge_gloom_cap"));
//		perFaceBlock(TFBlocks.huge_mushgloom_stem, prefix("block/huge_gloom_inside"), prefix("block/huge_mushgloom_stem"));
//		simpleBlock(TFBlocks.trollvidr, models().cross(TFBlocks.trollvidr.getId().getPath(), blockTexture(TFBlocks.trollvidr)));
//		simpleBlock(TFBlocks.unripe_trollber, models().cross(TFBlocks.unripe_trollber.getId().getPath(), blockTexture(TFBlocks.unripe_trollber)));
//		ModelFile trollber = models().withExistingParent(TFBlocks.trollber.getId().getPath(), prefix("block/util/cross_2_layer"))
//						.texture("cross", blockTexture(TFBlocks.trollber))
//						.texture("cross2", prefix("block/" + TFBlocks.trollber.getId().getPath() + "_glow"));
//		simpleBlock(TFBlocks.trollber, trollber);
//		lilyPad(TFBlocks.huge_lilypad);
//		simpleBlock(TFBlocks.huge_waterlily, models().cross(TFBlocks.huge_waterlily.getId().getPath(), blockTexture(TFBlocks.huge_waterlily)));
//		simpleBlock(TFBlocks.castle_brick);
//		simpleBlock(TFBlocks.castle_brick_worn);
//		simpleBlock(TFBlocks.castle_brick_cracked);
//		allRotations(TFBlocks.castle_brick_roof, cubeAll(TFBlocks.castle_brick_roof));
//		simpleBlock(TFBlocks.castle_brick_mossy);
//		simpleBlock(TFBlocks.castle_brick_frame);
//
//		rotationallyCorrectColumn(TFBlocks.castle_pillar_encased);
//		rotationallyCorrectColumn(TFBlocks.castle_pillar_bold);
//		simpleBlock(TFBlocks.castle_pillar_encased_tile, models().cubeAll(TFBlocks.castle_pillar_encased_tile.getId().getPath(), prefix("block/castle_pillar_encased_end")));
//		simpleBlock(TFBlocks.castle_pillar_bold_tile);
//		stairsBlock(TFBlocks.castle_stairs_brick, prefix("block/" + TFBlocks.castle_stairs_brick.getId().getPath()));
//		stairsBlock(TFBlocks.castle_stairs_worn, prefix("block/" + TFBlocks.castle_stairs_worn.getId().getPath()));
//		stairsBlock(TFBlocks.castle_stairs_cracked, prefix("block/" + TFBlocks.castle_stairs_cracked.getId().getPath()));
//		stairsBlock(TFBlocks.castle_stairs_mossy, prefix("block/" + TFBlocks.castle_stairs_mossy.getId().getPath()));
//		stairsBlock(TFBlocks.castle_stairs_encased, prefix("block/castle_pillar_encased_h"), prefix("block/castleblock_tile"), prefix("block/castle_brick_roof"));
//		stairsBlock(TFBlocks.castle_stairs_bold, prefix("block/castle_pillar_bold_tile"));
//
...
//		}
//
//		simpleBlock(TFBlocks.castle_rune_brick_yellow, runeBrickModels);
//		simpleBlock(TFBlocks.castle_rune_brick_purple, runeBrickModels);
//		simpleBlock(TFBlocks.castle_rune_brick_pink, runeBrickModels);
//		simpleBlock(TFBlocks.castle_rune_brick_blue, runeBrickModels);
//
//		logBlock(TFBlocks.cinder_log);
//		simpleBlock(TFBlocks.cinder_wood, models().cubeAll(TFBlocks.cinder_wood.getId().getPath(), prefix("block/" + TFBlocks.cinder_log.getId().getPath())));
...
//		horizontalBlock(TFBlocks.cinder_furnace, state -> state.getValue(AbstractFurnaceBlock.LIT) ? furnaceOn : furnaceOff);
//
//		castleDoor(TFBlocks.castle_door_yellow);
//		castleDoor(TFBlocks.castle_door_purple);
//		castleDoor(TFBlocks.castle_door_pink);
//		castleDoor(TFBlocks.castle_door_blue);
//
//		simpleBlockExisting(TFBlocks.knightmetal_block);
//		simpleBlockExisting(TFBlocks.ironwood_block);
//		simpleBlockExisting(TFBlocks.fiery_block);
//		simpleBlock(TFBlocks.arctic_fur_block);
...
//		allRotations(TFBlocks.steeleaf_block, steeleafBlock);
...
//		allRotations(TFBlocks.carminite_block, carminiteBlock);
//
//		simpleBlock(TFBlocks.twilight_portal_miniature_structure, models().getExistingFile(prefix("block/miniature/portal")));
//		simpleBlock(TFBlocks.naga_courtyard_miniature_structure, models().getExistingFile(prefix("block/miniature/naga_courtyard")));
//		simpleBlock(TFBlocks.lich_tower_miniature_structure, models().getExistingFile(prefix("block/miniature/lich_tower")));
//		mazestone();
//		simpleBlock(TFBlocks.hedge, ConfiguredModel.builder()
//						.weight(10).modelFile(models().cubeAll(TFBlocks.hedge.getId().getPath(), blockTexture(TFBlocks.hedge))).nextModel()
...
//		simpleBlock(TFBlocks.boss_spawner_naga, new ConfiguredModel(models().getExistingFile(new ResourceLocation("block/spawner"))));
//		simpleBlock(TFBlocks.boss_spawner_lich, new ConfiguredModel(models().getExistingFile(new ResourceLocation("block/spawner"))));
//		simpleBlock(TFBlocks.boss_spawner_hydra, new ConfiguredModel(models().getExistingFile(new ResourceLocation("block/spawner"))));
//		simpleBlock(TFBlocks.boss_spawner_ur_ghast, new ConfiguredModel(models().getExistingFile(new ResourceLocation("block/spawner"))));
//		simpleBlock(TFBlocks.boss_spawner_knight_phantom, new ConfiguredModel(models().getExistingFile(new ResourceLocation("block/spawner"))));
//		simpleBlock(TFBlocks.boss_spawner_snow_queen, new ConfiguredModel(models().getExistingFile(new ResourceLocation("block/spawner"))));
//		simpleBlock(TFBlocks.boss_spawner_minoshroom, new ConfiguredModel(models().getExistingFile(new ResourceLocation("block/spawner"))));
//		simpleBlock(TFBlocks.boss_spawner_alpha_yeti, new ConfiguredModel(models().getExistingFile(new ResourceLocation("block/spawner"))));
//		simpleBlock(TFBlocks.boss_spawner_final_boss, new ConfiguredModel(models().getExistingFile(new ResourceLocation("block/spawner"))));
//		simpleBlockExisting(TFBlocks.firefly_jar);
//		simpleBlockExisting(TFBlocks.firefly_spawner);
//		simpleBlockExisting(TFBlocks.cicada_jar);
//		registerPlantBlocks();
//		simpleBlock(TFBlocks.root);
//		simpleBlock(TFBlocks.liveroot_block);
//		simpleBlock(TFBlocks.uncrafting_table, models().withExistingParent(TFBlocks.uncrafting_table.getId().getPath(), prefix("block/util/cube_bottom_double_top"))
...
//		axisBlock(TFBlocks.stone_twist, prefix("block/stone_twist/twist_side"), prefix("block/stone_twist/twist_end"));
//		axisBlock(TFBlocks.stone_bold, prefix("block/stone_pillar_side"), prefix("block/stone_pillar_end"));
//		simpleBlock(TFBlocks.empty_bookshelf, models().cubeColumn("empty_bookshelf", prefix("block/wood/bookshelf_spawner/bookshelf_empty"), prefix("block/wood/planks_canopy_0")));
//		simpleBlock(TFBlocks.canopy_bookshelf, ConfiguredModel.builder()
...
//		getVariantBuilder(TFBlocks.tome_spawner).forAllStatesExcept(s -> {
...
//		//}
//		//simpleBlock(TFBlocks.lapis_block, lapisModels);
//		registerWoodBlocks();
//		registerNagastone();
//		registerForceFields();
//		simpleBlock(TFBlocks.potted_twilight_oak_sapling, models().getExistingFile(prefix("block/potted_twilight_oak_sapling")));
//		simpleBlock(TFBlocks.potted_canopy_sapling, models().getExistingFile(prefix("block/potted_canopy_sapling")));
//		simpleBlock(TFBlocks.potted_mangrove_sapling, models().getExistingFile(prefix("block/potted_mangrove_sapling")));
//		simpleBlock(TFBlocks.potted_darkwood_sapling, models().getExistingFile(prefix("block/potted_darkwood_sapling")));
//		simpleBlock(TFBlocks.potted_hollow_oak_sapling, models().getExistingFile(prefix("block/potted_hollow_oak_sapling")));
//		simpleBlock(TFBlocks.potted_rainboak_sapling, models().getExistingFile(prefix("block/potted_rainboak_sapling")));
//		simpleBlock(TFBlocks.potted_time_sapling, models().getExistingFile(prefix("block/potted_time_sapling")));
//		simpleBlock(TFBlocks.potted_trans_sapling, models().getExistingFile(prefix("block/potted_trans_sapling")));
//		simpleBlock(TFBlocks.potted_mine_sapling, models().getExistingFile(prefix("block/potted_mine_sapling")));
//		simpleBlock(TFBlocks.potted_sort_sapling, models().getExistingFile(prefix("block/potted_sort_sapling")));
//		simpleBlock(TFBlocks.potted_mayapple, models().getExistingFile(prefix("block/potted_mayapple")));
//		simpleBlock(TFBlocks.potted_fiddlehead, models().getExistingFile(prefix("block/potted_fiddlehead")));
//		simpleBlock(TFBlocks.potted_mushgloom, models().getExistingFile(prefix("block/potted_mushgloom")));
//		simpleBlock(TFBlocks.potted_thorn, models().getExistingFile(prefix("block/potted_thorn")));
//		simpleBlock(TFBlocks.potted_green_thorn, models().getExistingFile(prefix("block/potted_green_thorn")));
//		simpleBlock(TFBlocks.potted_dead_thorn, models().getExistingFile(prefix("block/potted_dead_thorn")));
//
//		builtinEntity(TFBlocks.twilight_oak_sign, "twilightforest:block/wood/planks_twilight_oak_0");
//		builtinEntity(TFBlocks.twilight_wall_sign, "twilightforest:block/wood/planks_twilight_oak_0");
//		builtinEntity(TFBlocks.canopy_sign, "twilightforest:block/wood/planks_canopy_0");
//		builtinEntity(TFBlocks.canopy_wall_sign, "twilightforest:block/wood/planks_canopy_0");
//		builtinEntity(TFBlocks.mangrove_sign, "twilightforest:block/wood/planks_mangrove_0");
//		builtinEntity(TFBlocks.mangrove_wall_sign, "twilightforest:block/wood/planks_mangrove_0");
//		builtinEntity(TFBlocks.darkwood_sign, "twilightforest:block/wood/planks_darkwood_0");
//		builtinEntity(TFBlocks.darkwood_wall_sign, "twilightforest:block/wood/planks_darkwood_0");
//		builtinEntity(TFBlocks.time_sign, "twilightforest:block/wood/planks_time_0");
//		builtinEntity(TFBlocks.time_wall_sign, "twilightforest:block/wood/planks_time_0");
//		builtinEntity(TFBlocks.trans_sign, "twilightforest:block/wood/planks_trans_0");
//		builtinEntity(TFBlocks.trans_wall_sign, "twilightforest:block/wood/planks_trans_0");
//		builtinEntity(TFBlocks.mine_sign, "twilightforest:block/wood/planks_mine_0");
//		builtinEntity(TFBlocks.mine_wall_sign, "twilightforest:block/wood/planks_mine_0");
//		builtinEntity(TFBlocks.sort_sign, "twilightforest:block/wood/planks_sort_0");
//		builtinEntity(TFBlocks.sort_wall_sign, "twilightforest:block/wood/planks_sort_0");
//
//		casketStuff();
//		stonePillar();
//		candelabra();
...
//		getVariantBuilder(TFBlocks.naga_stone).forAllStates(s -> {
...
//		});
//
//		horizontalBlock(TFBlocks.naga_stone_head, models().getExistingFile(prefix("block/" + TFBlocks.naga_stone_head.getId().getPath())));
//		nagastonePillar(TFBlocks.nagastone_pillar, "");
//		nagastonePillar(TFBlocks.nagastone_pillar_mossy, "_mossy");
//		nagastonePillar(TFBlocks.nagastone_pillar_weathered, "_weathered");
//		etchedNagastone(TFBlocks.etched_nagastone, "");
//		etchedNagastone(TFBlocks.etched_nagastone_mossy, "_mossy");
//		etchedNagastone(TFBlocks.etched_nagastone_weathered, "_weathered");
//		stairsBlock(TFBlocks.nagastone_stairs_left, prefix("block/etched_nagastone_left"), prefix("block/stone_tiles"), prefix("block/nagastone_bare"));
//		stairsBlock(TFBlocks.nagastone_stairs_right, prefix("block/etched_nagastone_right"), prefix("block/stone_tiles"), prefix("block/nagastone_bare"));
//		stairsBlock(TFBlocks.nagastone_stairs_mossy_left, prefix("block/etched_nagastone_left_mossy"), prefix("block/stone_tiles_mossy"), prefix("block/nagastone_bare_mossy"));
//		stairsBlock(TFBlocks.nagastone_stairs_mossy_right, prefix("block/etched_nagastone_right_mossy"), prefix("block/stone_tiles_mossy"), prefix("block/nagastone_bare_mossy"));
//		stairsBlock(TFBlocks.nagastone_stairs_weathered_left, prefix("block/etched_nagastone_left_weathered"), prefix("block/stone_tiles_weathered"), prefix("block/nagastone_bare_weathered"));
//		stairsBlock(TFBlocks.nagastone_stairs_weathered_right, prefix("block/etched_nagastone_right_weathered"), prefix("block/stone_tiles_weathered"), prefix("block/nagastone_bare_weathered"));
//	}
//
...
//		var builder = getVariantBuilder(TFBlocks.keepsake_casket);
//
//		var empty = models().getBuilder(TFBlocks.keepsake_casket.getRegistryName().getPath()).parent(new ModelFile.UncheckedModelFile("builtin/entity")).texture("particle", "minecraft:block/netherite_block");
...
//		simpleBlock(TFBlocks.smoker, new ConfiguredModel(models().getExistingFile(prefix("block/jet"))));
//		simpleBlock(TFBlocks.fire_jet, new ConfiguredModel(models().getExistingFile(prefix("block/jet"))));
//
...
//						.texture("bottom", blockTexture(TFBlocks.tower_wood_encased))
...
//		getVariantBuilder(TFBlocks.encased_smoker).partialState()
...
//
//		getVariantBuilder(TFBlocks.encased_fire_jet).partialState()
...
//		simpleBlockExisting(TFBlocks.moss_patch);
//		simpleBlockExisting(TFBlocks.mayapple);
...
//		}
//		simpleBlock(TFBlocks.clover_patch, cloverModels);
//		simpleBlock(TFBlocks.fiddlehead, models().withExistingParent(TFBlocks.fiddlehead.getId().getPath(), "block/tinted_cross")
//						.texture("cross", blockTexture(TFBlocks.fiddlehead)));
//		simpleBlock(TFBlocks.mushgloom, models().withExistingParent(TFBlocks.mushgloom.getId().getPath(), prefix("block/util/cross_2_layer"))
//						.texture("cross", blockTexture(TFBlocks.mushgloom))
...
//				.texture("cross", blockTexture(TFBlocks.torchberry_plant))
...
//				.texture("cross", blockTexture(TFBlocks.torchberry_plant));
//		getVariantBuilder(TFBlocks.torchberry_plant).forAllStates(s -> ConfiguredModel.builder().modelFile(s.getValue(TorchberryPlantBlock.HAS_BERRIES) ? berry : noBerry).build());
//
//		simpleBlockExisting(TFBlocks.root_strand);
//		simpleBlockExisting(TFBlocks.fallen_leaves);
//	}
//
//	private void registerWoodBlocks() {
//		logWoodSapling(TFBlocks.oak_log, TFBlocks.stripped_oak_log, TFBlocks.oak_wood, TFBlocks.stripped_oak_wood, TFBlocks.oak_sapling);
//		plankBlocks("twilight_oak", TFBlocks.twilight_oak_planks, TFBlocks.twilight_oak_slab, TFBlocks.twilight_oak_stairs, TFBlocks.twilight_oak_button, TFBlocks.twilight_oak_fence, TFBlocks.twilight_oak_gate, TFBlocks.twilight_oak_plate, TFBlocks.twilight_oak_door, TFBlocks.twilight_oak_trapdoor, TFBlocks.twilight_oak_banister);
//		singleBlockBoilerPlate(TFBlocks.oak_leaves, "block/leaves", m -> m.texture("all", "minecraft:block/oak_leaves"));
//
//		ResourceLocation rainboakSaplTex = prefix("block/" + TFBlocks.rainboak_sapling.getId().getPath());
//		simpleBlock(TFBlocks.rainboak_sapling, models().cross(TFBlocks.rainboak_sapling.getId().getPath(), rainboakSaplTex));
//		singleBlockBoilerPlate(TFBlocks.rainboak_leaves, "block/leaves", m -> m.texture("all", "minecraft:block/oak_leaves"));
//
//		logWoodSapling(TFBlocks.canopy_log, TFBlocks.stripped_canopy_log, TFBlocks.canopy_wood, TFBlocks.stripped_canopy_wood, TFBlocks.canopy_sapling);
//		plankBlocks("canopy", TFBlocks.canopy_planks, TFBlocks.canopy_slab, TFBlocks.canopy_stairs, TFBlocks.canopy_button, TFBlocks.canopy_fence, TFBlocks.canopy_gate, TFBlocks.canopy_plate, TFBlocks.canopy_door, TFBlocks.canopy_trapdoor, TFBlocks.canopy_banister);
//		singleBlockBoilerPlate(TFBlocks.canopy_leaves, "block/leaves", m -> m.texture("all", "minecraft:block/spruce_leaves"));
//
//		logWoodSapling(TFBlocks.mangrove_log, TFBlocks.stripped_mangrove_log, TFBlocks.mangrove_wood, TFBlocks.stripped_mangrove_wood, TFBlocks.mangrove_sapling);
//		plankBlocks("mangrove", TFBlocks.mangrove_planks, TFBlocks.mangrove_slab, TFBlocks.mangrove_stairs, TFBlocks.mangrove_button, TFBlocks.mangrove_fence, TFBlocks.mangrove_gate, TFBlocks.mangrove_plate, TFBlocks.mangrove_door, TFBlocks.mangrove_trapdoor, TFBlocks.mangrove_banister);
//		singleBlockBoilerPlate(TFBlocks.mangrove_leaves, "block/leaves", m -> m.texture("all", "minecraft:block/birch_leaves"));
//
//		logWoodSapling(TFBlocks.dark_log, TFBlocks.stripped_dark_log, TFBlocks.dark_wood, TFBlocks.stripped_dark_wood, TFBlocks.darkwood_sapling);
//		plankBlocks("darkwood", TFBlocks.dark_planks, TFBlocks.dark_slab, TFBlocks.dark_stairs, TFBlocks.dark_button, TFBlocks.dark_fence, TFBlocks.dark_gate, TFBlocks.dark_plate, TFBlocks.dark_door, TFBlocks.dark_trapdoor, TFBlocks.darkwood_banister);
//		singleBlockBoilerPlate(TFBlocks.dark_leaves, "block/leaves", m -> m.texture("all", "block/darkwood_leaves"));
//		singleBlockBoilerPlate(TFBlocks.hardened_dark_leaves, "block/leaves", m -> m.texture("all", "block/darkwood_leaves"));
//
//		logWoodSapling(TFBlocks.time_log, TFBlocks.stripped_time_log, TFBlocks.time_wood, TFBlocks.stripped_time_wood, TFBlocks.time_sapling);
//		plankBlocks("time", TFBlocks.time_planks, TFBlocks.time_slab, TFBlocks.time_stairs, TFBlocks.time_button, TFBlocks.time_fence, TFBlocks.time_gate, TFBlocks.time_plate, TFBlocks.time_door, TFBlocks.time_trapdoor, TFBlocks.time_banister);
//		singleBlockBoilerPlate(TFBlocks.time_leaves, "block/leaves", m -> m.texture("all", "block/time_leaves"));
//		magicLogCore(TFBlocks.time_log_core);
//
//		logWoodSapling(TFBlocks.transformation_log, TFBlocks.stripped_transformation_log, TFBlocks.transformation_wood, TFBlocks.stripped_transformation_wood, TFBlocks.transformation_sapling);
//		plankBlocks("trans", TFBlocks.trans_planks, TFBlocks.trans_slab, TFBlocks.trans_stairs, TFBlocks.trans_button, TFBlocks.trans_fence, TFBlocks.trans_gate, TFBlocks.trans_plate, TFBlocks.trans_door, TFBlocks.trans_trapdoor, TFBlocks.trans_banister);
//		singleBlockBoilerPlate(TFBlocks.transformation_leaves, "block/leaves", m -> m.texture("all", "block/transformation_leaves"));
//		magicLogCore(TFBlocks.transformation_log_core);
//
//		logWoodSapling(TFBlocks.mining_log, TFBlocks.stripped_mining_log, TFBlocks.mining_wood, TFBlocks.stripped_mining_wood, TFBlocks.mining_sapling);
//		plankBlocks("mine", TFBlocks.mine_planks, TFBlocks.mine_slab, TFBlocks.mine_stairs, TFBlocks.mine_button, TFBlocks.mine_fence, TFBlocks.mine_gate, TFBlocks.mine_plate, TFBlocks.mine_door, TFBlocks.mine_trapdoor, TFBlocks.mine_banister);
//		singleBlockBoilerPlate(TFBlocks.mining_leaves, "block/leaves", m -> m.texture("all", "block/mining_leaves"));
//		magicLogCore(TFBlocks.mining_log_core);
//
//		logWoodSapling(TFBlocks.sorting_log, TFBlocks.stripped_sorting_log, TFBlocks.sorting_wood, TFBlocks.stripped_sorting_wood, TFBlocks.sorting_sapling);
//		plankBlocks("sort", TFBlocks.sort_planks, TFBlocks.sort_slab, TFBlocks.sort_stairs, TFBlocks.sort_button, TFBlocks.sort_fence, TFBlocks.sort_gate, TFBlocks.sort_plate, TFBlocks.sort_door, TFBlocks.sort_trapdoor, TFBlocks.sort_banister);
//		singleBlockBoilerPlate(TFBlocks.sorting_leaves, "block/leaves", m -> m.texture("all", "block/sorting_leaves"));
//		magicLogCore(TFBlocks.sorting_log_core);
//
//		banisterVanilla(TFBlocks.oak_banister, "oak_planks");
//		banisterVanilla(TFBlocks.spruce_banister, "spruce_planks");
//		banisterVanilla(TFBlocks.birch_banister, "birch_planks");
//		banisterVanilla(TFBlocks.jungle_banister, "jungle_planks");
//		banisterVanilla(TFBlocks.acacia_banister, "acacia_planks");
//		banisterVanilla(TFBlocks.dark_oak_banister, "dark_oak_planks");
//		banisterVanilla(TFBlocks.crimson_banister, "crimson_planks");
//		banisterVanilla(TFBlocks.warped_banister, "warped_planks");
//	}
//
...
//						.texture("bot_right", prefix("block/terrorcotta_c"));
//
//		getVariantBuilder(TFBlocks.terrorcotta_circle).partialState()
...
//						.texture("bot_left", prefix("block/terrorcotta_0"))
//						.texture("bot_right", prefix("block/terrorcotta_1"));
//		getVariantBuilder(TFBlocks.terrorcotta_diagonal).partialState()
...
//		getMultipartBuilder(TFBlocks.stone_twist_thin)
...
//		getVariantBuilder(TFBlocks.slider).forAllStates(state -> {
...
//		getVariantBuilder(TFBlocks.reappearing_block).forAllStates(s -> {
//			ModelFile model;
...
//		getVariantBuilder(TFBlocks.vanishing_block).partialState()
...
//		getVariantBuilder(TFBlocks.locked_vanishing_block).partialState()
...
//		getVariantBuilder(TFBlocks.ghast_trap).partialState()
...
//		getVariantBuilder(TFBlocks.carminite_builder).partialState()
...
//						.texture("all2", prefix("block/tower_device_level_1/towerdev_builder_on_1"));
//		getVariantBuilder(TFBlocks.built_block).partialState()
...
//		simpleBlock(TFBlocks.antibuilder, antibuilder);
...
//		simpleBlock(TFBlocks.antibuilt_block, antibuilt);
//
...
//		getVariantBuilder(TFBlocks.carminite_reactor).partialState()
...
//		simpleBlock(TFBlocks.reactor_debris, models().cubeAll(TFBlocks.reactor_debris.getId().getPath(), new ResourceLocation("block/destroy_stage_9")));
//	}
//
...
//		}
//		getVariantBuilder(TFBlocks.trophy_pedestal).partialState()
...
//						.texture("side", prefix("block/green_thorns_side"))
//						.texture("end", prefix("block/green_thorns_top"));
//		getMultipartBuilder(TFBlocks.green_thorns)
...
//						.texture("side", prefix("block/brown_thorns_side"))
//						.texture("end", prefix("block/brown_thorns_top"));
//		getMultipartBuilder(TFBlocks.brown_thorns)
...
//						.texture("side", prefix("block/burnt_thorns_side"))
//						.texture("end", prefix("block/burnt_thorns_top"));
//		getMultipartBuilder(TFBlocks.burnt_thorns)
...
//		}
//		for (int i = 0; i < variants; i++) {
//			getVariantBuilder(TFBlocks.aurora_block).partialState().with(AuroraBrickBlock.VARIANT, i)
...
//						.texture("side", blockTexture(TFBlocks.aurora_pillar));
//		axisBlock(TFBlocks.aurora_pillar, pillarModel, pillarModel);
//
...
//						.texture("side", prefix("block/" + TFBlocks.aurora_slab.getId().getPath() + "_side"));
//
//		getVariantBuilder(TFBlocks.aurora_slab).partialState()
...
//						.texture("all", blockTexture(TFBlocks.auroralized_glass));
//		simpleBlock(TFBlocks.auroralized_glass, auroraGlass);
//	}
//
//	private void mazestone() {
//		ResourceLocation plainTex = blockTexture(TFBlocks.maze_stone);
//
//		ModelFile mazeStone = models().cubeAll(TFBlocks.maze_stone.getId().getPath(), plainTex);
//		simpleBlock(TFBlocks.maze_stone, ConfiguredModel.builder()
//						.rotationX(90).rotationY(90).modelFile(mazeStone).nextModel()
//						.rotationX(270).rotationY(270).modelFile(mazeStone).build());
//		simpleBlock(TFBlocks.maze_stone_brick);
//
//		ModelFile chiseled = models().cubeColumn(TFBlocks.maze_stone_chiseled.getId().getPath(), blockTexture(TFBlocks.maze_stone_chiseled), plainTex);
//		simpleBlock(TFBlocks.maze_stone_chiseled, chiseled);
//
//		ModelFile decorative = models().cubeColumn(TFBlocks.maze_stone_decorative.getId().getPath(), blockTexture(TFBlocks.maze_stone_decorative), plainTex);
//		simpleBlock(TFBlocks.maze_stone_decorative, decorative);
//
//		simpleBlock(TFBlocks.maze_stone_cracked);
//		simpleBlock(TFBlocks.maze_stone_mossy);
//
//		ResourceLocation brickTex = blockTexture(TFBlocks.maze_stone_brick);
//		ModelFile mosaic = models().cubeColumn(TFBlocks.maze_stone_mosaic.getId().getPath(), brickTex, blockTexture(TFBlocks.maze_stone_mosaic));
//		simpleBlock(TFBlocks.maze_stone_mosaic, mosaic);
//
//		ModelFile border = models().cubeColumn(TFBlocks.maze_stone_border.getId().getPath(), brickTex, blockTexture(TFBlocks.maze_stone_border));
//		simpleBlock(TFBlocks.maze_stone_border, border);
//	}
//
...
//				.weight(1).modelFile(models().cubeAll(plank.getRegistryName().getPath() + "_3", tex3)).build();*/
//
//		this.getVariantBuilder(TFBlocks.candelabra).forAllStates(state -> {
