...
public class AdvancementGenerator implements Consumer<Consumer<Advancement>> {
	...
	private static final Block[] DENDROLOGIST_BLOCKS = new Block[]{
			...
			TFBlocks.twilight_oak_banister.get(), TFBlocks.canopy_banister.get(), TFBlocks.mangrove_banister.get(), TFBlocks.darkwood_banister.get(), TFBlocks.time_banister.get(), TFBlocks.trans_banister.get(), TFBlocks.mine_banister.get(), TFBlocks.sort_banister.get()
	};
