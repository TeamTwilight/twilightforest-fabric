...
//	public static final Block final_castle_miniature_structure       =  Registry.register(Registry.BLOCK, TwilightForestMod.ID+":"+"final_castle_miniature_structure", new BlockTFMiniatureStructure());
	...
	public static final net.minecraft.world.level.block.WallSignBlock canopy_wall_sign      =  Registry.register(Registry.BLOCK, TwilightForestMod.ID+":"+"canopy_wall_sign", new TFWallSignBlock(BlockBehaviour.Properties.copy(canopy_planks).strength(3.0F).sound(SoundType.WOOD).noOcclusion().noCollission(), CANOPY));
	...
	public static final net.minecraft.world.level.block.WallSignBlock mangrove_wall_sign    =  Registry.register(Registry.BLOCK, TwilightForestMod.ID+":"+"mangrove_wall_sign", new TFWallSignBlock(BlockBehaviour.Properties.copy(mangrove_planks).strength(3.0F).sound(SoundType.WOOD).noOcclusion().noCollission(), MANGROVE));
	...
	public static final net.minecraft.world.level.block.WallSignBlock darkwood_wall_sign    =  Registry.register(Registry.BLOCK, TwilightForestMod.ID+":"+"darkwood_wall_sign", new TFWallSignBlock(BlockBehaviour.Properties.copy(dark_planks).strength(3.0F).sound(SoundType.WOOD).noOcclusion().noCollission(), DARKWOOD));
	...
	public static final net.minecraft.world.level.block.WallSignBlock time_wall_sign        =  Registry.register(Registry.BLOCK, TwilightForestMod.ID+":"+"time_wall_sign", new TFWallSignBlock(BlockBehaviour.Properties.copy(time_planks).strength(3.0F).sound(SoundType.WOOD).noOcclusion().noCollission(), TIMEWOOD));
	...
	public static final net.minecraft.world.level.block.WallSignBlock trans_wall_sign       =  Registry.register(Registry.BLOCK, TwilightForestMod.ID+":"+"trans_wall_sign", new TFWallSignBlock(BlockBehaviour.Properties.copy(trans_planks).strength(3.0F).sound(SoundType.WOOD).noOcclusion().noCollission(), TRANSFORMATION));
	...
	public static final net.minecraft.world.level.block.WallSignBlock mine_wall_sign        =  Registry.register(Registry.BLOCK, TwilightForestMod.ID+":"+"mine_wall_sign", new TFWallSignBlock(BlockBehaviour.Properties.copy(mine_planks).strength(3.0F).sound(SoundType.WOOD).noOcclusion().noCollission(), MINING));
	...
	public static final net.minecraft.world.level.block.WallSignBlock sort_wall_sign        =  Registry.register(Registry.BLOCK, TwilightForestMod.ID+":"+"sort_wall_sign", new TFWallSignBlock(BlockBehaviour.Properties.copy(sort_planks).strength(3.0F).sound(SoundType.WOOD).noOcclusion().noCollission(), SORTING));
	...
	public static void TFBurnables() {
		...
		FlammableBlockRegistry.getDefaultInstance().add(root, 20, 5);
		FlammableBlockRegistry.getDefaultInstance().add(liveroot_block, 20, 5);
		FlammableBlockRegistry.getDefaultInstance().add(oak_wood, 5, 5);
		FlammableBlockRegistry.getDefaultInstance().add(twilight_oak_planks, 20, 5);
		FlammableBlockRegistry.getDefaultInstance().add(twilight_oak_slab, 20, 5);
		FlammableBlockRegistry.getDefaultInstance().add(twilight_oak_stairs, 20, 5);
		FlammableBlockRegistry.getDefaultInstance().add(twilight_oak_fence, 20, 5);
		FlammableBlockRegistry.getDefaultInstance().add(twilight_oak_gate, 20, 5);
		FlammableBlockRegistry.getDefaultInstance().add(canopy_wood, 5, 5);
		FlammableBlockRegistry.getDefaultInstance().add(canopy_planks, 20, 5);
		FlammableBlockRegistry.getDefaultInstance().add(canopy_slab, 20, 5);
		FlammableBlockRegistry.getDefaultInstance().add(canopy_stairs, 20, 5);
		FlammableBlockRegistry.getDefaultInstance().add(canopy_fence, 20, 5);
		FlammableBlockRegistry.getDefaultInstance().add(canopy_gate, 20, 5);
		FlammableBlockRegistry.getDefaultInstance().add(mangrove_wood, 5, 5);
		FlammableBlockRegistry.getDefaultInstance().add(mangrove_planks, 20, 5);
		FlammableBlockRegistry.getDefaultInstance().add(mangrove_slab, 20, 5);
		FlammableBlockRegistry.getDefaultInstance().add(mangrove_stairs, 20, 5);
		FlammableBlockRegistry.getDefaultInstance().add(mangrove_fence, 20, 5);
		FlammableBlockRegistry.getDefaultInstance().add(mangrove_gate, 20, 5);
		FlammableBlockRegistry.getDefaultInstance().add(dark_wood, 5, 5);
		FlammableBlockRegistry.getDefaultInstance().add(dark_planks, 20, 5);
		FlammableBlockRegistry.getDefaultInstance().add(dark_slab, 20, 5);
		FlammableBlockRegistry.getDefaultInstance().add(dark_stairs, 20, 5);
		FlammableBlockRegistry.getDefaultInstance().add(dark_fence, 20, 5);
		FlammableBlockRegistry.getDefaultInstance().add(dark_gate, 20, 5);
		FlammableBlockRegistry.getDefaultInstance().add(time_wood, 5, 5);
		FlammableBlockRegistry.getDefaultInstance().add(time_planks, 20, 5);
		FlammableBlockRegistry.getDefaultInstance().add(time_slab, 20, 5);
		FlammableBlockRegistry.getDefaultInstance().add(time_stairs, 20, 5);
		FlammableBlockRegistry.getDefaultInstance().add(time_fence, 20, 5);
		FlammableBlockRegistry.getDefaultInstance().add(time_gate, 20, 5);
		FlammableBlockRegistry.getDefaultInstance().add(transformation_wood, 5, 5);
		FlammableBlockRegistry.getDefaultInstance().add(trans_planks, 20, 5);
		FlammableBlockRegistry.getDefaultInstance().add(trans_slab, 20, 5);
		FlammableBlockRegistry.getDefaultInstance().add(trans_stairs, 20, 5);
		FlammableBlockRegistry.getDefaultInstance().add(trans_fence, 20, 5);
		FlammableBlockRegistry.getDefaultInstance().add(trans_gate, 20, 5);
		FlammableBlockRegistry.getDefaultInstance().add(mining_wood, 5, 5);
		FlammableBlockRegistry.getDefaultInstance().add(mine_planks, 20, 5);
		FlammableBlockRegistry.getDefaultInstance().add(mine_slab, 20, 5);
		FlammableBlockRegistry.getDefaultInstance().add(mine_stairs, 20, 5);
		FlammableBlockRegistry.getDefaultInstance().add(mine_fence, 20, 5);
		FlammableBlockRegistry.getDefaultInstance().add(mine_gate, 20, 5);
		FlammableBlockRegistry.getDefaultInstance().add(sorting_wood, 5, 5);
		FlammableBlockRegistry.getDefaultInstance().add(sort_planks, 20, 5);
		FlammableBlockRegistry.getDefaultInstance().add(sort_slab, 20, 5);
		FlammableBlockRegistry.getDefaultInstance().add(sort_stairs, 20, 5);
		FlammableBlockRegistry.getDefaultInstance().add(sort_fence, 20, 5);
		FlammableBlockRegistry.getDefaultInstance().add(sort_gate, 20, 5);
	}
