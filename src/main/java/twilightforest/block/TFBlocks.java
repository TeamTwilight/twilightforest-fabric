...
public class TFBlocks {
	...
	public static final Block oak_leaves                 = Registry.register(Registry.BLOCK, TwilightForestMod.ID+":twilight_oak_leaves", new TFLeavesBlock(BlockBehaviour.Properties.of(Material.LEAVES).strength(0.2F).randomTicks().noOcclusion().sound(SoundType.GRASS)));
	public static final Block canopy_leaves              = Registry.register(Registry.BLOCK, TwilightForestMod.ID+":canopy_leaves", new TFLeavesBlock(BlockBehaviour.Properties.of(Material.LEAVES).strength(0.2F).randomTicks().noOcclusion().sound(SoundType.GRASS)));
	public static final Block mangrove_leaves            = Registry.register(Registry.BLOCK, TwilightForestMod.ID+":mangrove_leaves", new TFLeavesBlock(BlockBehaviour.Properties.of(Material.LEAVES).strength(0.2F).randomTicks().noOcclusion().sound(SoundType.GRASS)));
	public static final Block dark_leaves                = Registry.register(Registry.BLOCK, TwilightForestMod.ID+":dark_leaves", new DarkLeavesBlock(BlockBehaviour.Properties.of(Material.LEAVES).strength(2.0F, 10.0F).sound(SoundType.GRASS)));
	public static final Block rainboak_leaves            = Registry.register(Registry.BLOCK, TwilightForestMod.ID+":rainboak_leaves", new TFLeavesBlock(BlockBehaviour.Properties.of(Material.LEAVES).strength(0.2F).randomTicks().noOcclusion().sound(SoundType.GRASS)));
	...
	public static final Block time_leaves                = Registry.register(Registry.BLOCK, TwilightForestMod.ID+":time_leaves", new MagicLeavesBlock(BlockBehaviour.Properties.of(Material.LEAVES).strength(0.2F).sound(SoundType.GRASS).randomTicks().noOcclusion()));
	public static final Block transformation_leaves      = Registry.register(Registry.BLOCK, TwilightForestMod.ID+":transformation_leaves", new MagicLeavesBlock(BlockBehaviour.Properties.of(Material.LEAVES).strength(0.2F).sound(SoundType.GRASS).randomTicks().noOcclusion()));
	public static final Block mining_leaves              = Registry.register(Registry.BLOCK, TwilightForestMod.ID+":mining_leaves", new MagicLeavesBlock(BlockBehaviour.Properties.of(Material.LEAVES).strength(0.2F).sound(SoundType.GRASS).randomTicks().noOcclusion()));
	public static final Block sorting_leaves             = Registry.register(Registry.BLOCK, TwilightForestMod.ID+":sorting_leaves", new MagicLeavesBlock(BlockBehaviour.Properties.of(Material.LEAVES).strength(0.2F).sound(SoundType.GRASS).randomTicks().noOcclusion()));
	...
	public static final Block thorn_leaves                = Registry.register(Registry.BLOCK, TwilightForestMod.ID+":thorn_leaves", new TFLeavesBlock(BlockBehaviour.Properties.of(Material.LEAVES).strength(0.2F).randomTicks().noOcclusion().sound(SoundType.GRASS)));
	public static final Block beanstalk_leaves            = Registry.register(Registry.BLOCK, TwilightForestMod.ID+":beanstalk_leaves", new TFLeavesBlock(BlockBehaviour.Properties.of(Material.LEAVES).strength(0.2F).randomTicks().noOcclusion().sound(SoundType.GRASS)));
	...
	public static final Block giant_leaves                = Registry.register(Registry.BLOCK, TwilightForestMod.ID+":giant_leaves", new GiantLeavesBlock(BlockBehaviour.Properties.copy(Blocks.OAK_LEAVES).requiresCorrectToolForDrops().strength(0.2F * 64F, 0.0F).noOcclusion()));
