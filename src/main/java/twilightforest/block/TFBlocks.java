...
public class TFBlocks {
	...
	public static final RegistryObject<Block> TROLLSTEINN = BLOCKS.register("trollsteinn", () -> new TrollsteinnBlock(BlockBehaviour.Properties.of(Material.STONE).requiresCorrectToolForDrops().strength(2.0F, 6.0F).sound(SoundType.STONE)));
...
//	public static final RegistryObject<Block> FINAL_CASTLE_MINIATURE_STRUCTURE = BLOCKS.register("final_castle_miniature_structure", () -> new BlockTFMiniatureStructure());
	...
	public static final RegistryObject<Block> MANGROVE_LEAVES = BLOCKS.register("mangrove_leaves", () -> new MangroveLeavesBlock(BlockBehaviour.Properties.of(Material.LEAVES).strength(0.2F).randomTicks().noOcclusion().sound(SoundType.AZALEA_LEAVES).isSuffocating((state, getter, pos) -> false).isViewBlocking((state, getter, pos) -> false)));
	...
	public static final RegistryObject<SaplingBlock> TWILIGHT_OAK_SAPLING = BLOCKS.register("twilight_oak_sapling", () -> new SaplingBlock(new SmallOakTree(), BlockBehaviour.Properties.of(Material.PLANT).instabreak().sound(SoundType.GRASS).noCollission().randomTicks()));
	public static final RegistryObject<SaplingBlock> CANOPY_SAPLING = BLOCKS.register("canopy_sapling", () -> new SaplingBlock(new CanopyTree(), BlockBehaviour.Properties.of(Material.PLANT).instabreak().sound(SoundType.GRASS).noCollission().randomTicks()));
	public static final RegistryObject<SaplingBlock> MANGROVE_SAPLING = BLOCKS.register("mangrove_sapling", () -> new MangroveSaplingBlock(new MangroveTree(), BlockBehaviour.Properties.of(Material.PLANT).instabreak().sound(SoundType.GRASS).noCollission().randomTicks()));
	public static final RegistryObject<SaplingBlock> DARKWOOD_SAPLING = BLOCKS.register("darkwood_sapling", () -> new SaplingBlock(new DarkCanopyTree(), BlockBehaviour.Properties.of(Material.PLANT).instabreak().sound(SoundType.GRASS).noCollission().randomTicks()));
	public static final RegistryObject<SaplingBlock> HOLLOW_OAK_SAPLING = BLOCKS.register("hollow_oak_sapling", () -> new SaplingBlock(new HollowTree(), BlockBehaviour.Properties.of(Material.PLANT).instabreak().sound(SoundType.GRASS).noCollission().randomTicks()));
	public static final RegistryObject<SaplingBlock> TIME_SAPLING = BLOCKS.register("time_sapling", () -> new SaplingBlock(new TimeTree(), BlockBehaviour.Properties.of(Material.PLANT).instabreak().sound(SoundType.GRASS).noCollission().randomTicks()));
	public static final RegistryObject<SaplingBlock> TRANSFORMATION_SAPLING = BLOCKS.register("transformation_sapling", () -> new SaplingBlock(new TransformationTree(), BlockBehaviour.Properties.of(Material.PLANT).instabreak().sound(SoundType.GRASS).noCollission().randomTicks()));
	public static final RegistryObject<SaplingBlock> MINING_SAPLING = BLOCKS.register("mining_sapling", () -> new SaplingBlock(new MinersTree(), BlockBehaviour.Properties.of(Material.PLANT).instabreak().sound(SoundType.GRASS).noCollission().randomTicks()));
