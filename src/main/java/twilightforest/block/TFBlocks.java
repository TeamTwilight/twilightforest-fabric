...
public class TFBlocks {
	...
	public static final Block vanishing_block            = Registry.register(Registry.BLOCK, TFConstants.ID + ":vanishing_block", new VanishingBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.SAND).strength(-1.0F, 35.0F).sound(SoundType.WOOD).lightLevel((state) -> state.getValue(VanishingBlock.ACTIVE) ? 4 : 0)));
	public static final Block locked_vanishing_block     = Registry.register(Registry.BLOCK, TFConstants.ID + ":locked_vanishing_block", new LockedVanishingBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.SAND).strength(-1.0F, 35.0F).sound(SoundType.WOOD)));
	public static final Block carminite_builder          = Registry.register(Registry.BLOCK, TFConstants.ID + ":carminite_builder", new BuilderBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.SAND).requiresCorrectToolForDrops().strength(10.0F, 35.0F).sound(SoundType.WOOD).lightLevel((state) -> state.getValue(BuilderBlock.STATE) == TowerDeviceVariant.BUILDER_ACTIVE ? 4 : 0)));
	public static final Block built_block                = Registry.register(Registry.BLOCK, TFConstants.ID + ":built_block", new TranslucentBuiltBlock(BlockBehaviour.Properties.of(Material.GLASS).strength(50.0F, 2000.0F).sound(SoundType.METAL).noOcclusion().noDrops()));
	public static final Block antibuilder                = Registry.register(Registry.BLOCK, TFConstants.ID + ":antibuilder", new AntibuilderBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.SAND).requiresCorrectToolForDrops().strength(10.0F, 35.0F).sound(SoundType.WOOD).lightLevel((state) -> 10)));
	public static final Block antibuilt_block            = Registry.register(Registry.BLOCK, TFConstants.ID + ":antibuilt_block", new Block(BlockBehaviour.Properties.of(Material.GLASS).strength(0.3F, 2000.0F).sound(SoundType.METAL).noDrops().noOcclusion()));
	public static final GhastTrapBlock ghast_trap        = Registry.register(Registry.BLOCK, TFConstants.ID + ":ghast_trap", new GhastTrapBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.SAND).requiresCorrectToolForDrops().strength(10.0F, 35.0F).sound(SoundType.WOOD).lightLevel((state) -> state.getValue(GhastTrapBlock.ACTIVE) ? 15 : 0)));
	public static final Block carminite_reactor          = Registry.register(Registry.BLOCK, TFConstants.ID + ":carminite_reactor", new CarminiteReactorBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.SAND).requiresCorrectToolForDrops().strength(10.0F, 35.0F).sound(SoundType.WOOD).lightLevel((state) -> state.getValue(CarminiteReactorBlock.ACTIVE) ? 15 : 0)));
	public static final Block reactor_debris             = Registry.register(Registry.BLOCK, TFConstants.ID + ":reactor_debris", new Block(BlockBehaviour.Properties.of(Material.GLASS).strength(0.3F, 2000.0F).sound(SoundType.METAL).noDrops().noOcclusion()));
	public static final Block fake_gold                  = Registry.register(Registry.BLOCK, TFConstants.ID + ":fake_gold", new Block(BlockBehaviour.Properties.of(Material.GLASS).strength(50.0F, 2000.0F).sound(SoundType.METAL).noDrops()));
	public static final Block fake_diamond               = Registry.register(Registry.BLOCK, TFConstants.ID + ":fake_diamond", new Block(BlockBehaviour.Properties.of(Material.GLASS).strength(50.0F, 2000.0F).sound(SoundType.METAL).noDrops()));
	public static final TrophyBlock naga_trophy           = Registry.register(Registry.BLOCK, TFConstants.ID + ":naga_trophy", new TrophyBlock(BossVariant.NAGA, 5));
	public static final TrophyBlock lich_trophy           = Registry.register(Registry.BLOCK, TFConstants.ID + ":lich_trophy", new TrophyBlock(BossVariant.LICH, 6));
	public static final TrophyBlock hydra_trophy          = Registry.register(Registry.BLOCK, TFConstants.ID + ":hydra_trophy", new TrophyBlock(BossVariant.HYDRA, 12));
	public static final TrophyBlock ur_ghast_trophy       = Registry.register(Registry.BLOCK, TFConstants.ID + ":ur_ghast_trophy", new TrophyBlock(BossVariant.UR_GHAST, 13));
	public static final TrophyBlock knight_phantom_trophy = Registry.register(Registry.BLOCK, TFConstants.ID + ":knight_phantom_trophy", new TrophyBlock(BossVariant.KNIGHT_PHANTOM, 8));
	public static final TrophyBlock snow_queen_trophy     = Registry.register(Registry.BLOCK, TFConstants.ID + ":snow_queen_trophy", new TrophyBlock(BossVariant.SNOW_QUEEN, 14));
	public static final TrophyBlock minoshroom_trophy     = Registry.register(Registry.BLOCK, TFConstants.ID + ":minoshroom_trophy", new TrophyBlock(BossVariant.MINOSHROOM, 7));
	public static final TrophyBlock yeti_trophy           = Registry.register(Registry.BLOCK, TFConstants.ID + ":yeti_trophy", new TrophyBlock(BossVariant.ALPHA_YETI, 9));
	public static final TrophyBlock quest_ram_trophy      = Registry.register(Registry.BLOCK, TFConstants.ID + ":quest_ram_trophy", new TrophyBlock(BossVariant.QUEST_RAM, 1));
	public static final TrophyWallBlock naga_wall_trophy           = Registry.register(Registry.BLOCK, TFConstants.ID + ":naga_wall_trophy", new TrophyWallBlock(BossVariant.NAGA));
	public static final TrophyWallBlock lich_wall_trophy           = Registry.register(Registry.BLOCK, TFConstants.ID + ":lich_wall_trophy", new TrophyWallBlock(BossVariant.LICH));
	public static final TrophyWallBlock hydra_wall_trophy          = Registry.register(Registry.BLOCK, TFConstants.ID + ":hydra_wall_trophy", new TrophyWallBlock(BossVariant.HYDRA));
	public static final TrophyWallBlock ur_ghast_wall_trophy       = Registry.register(Registry.BLOCK, TFConstants.ID + ":ur_ghast_wall_trophy", new TrophyWallBlock(BossVariant.UR_GHAST));
	public static final TrophyWallBlock knight_phantom_wall_trophy = Registry.register(Registry.BLOCK, TFConstants.ID + ":knight_phantom_wall_trophy", new TrophyWallBlock(BossVariant.KNIGHT_PHANTOM));
	public static final TrophyWallBlock snow_queen_wall_trophy     = Registry.register(Registry.BLOCK, TFConstants.ID + ":snow_queen_wall_trophy", new TrophyWallBlock(BossVariant.SNOW_QUEEN));
	public static final TrophyWallBlock minoshroom_wall_trophy     = Registry.register(Registry.BLOCK, TFConstants.ID + ":minoshroom_wall_trophy", new TrophyWallBlock(BossVariant.MINOSHROOM));
	public static final TrophyWallBlock yeti_wall_trophy           = Registry.register(Registry.BLOCK, TFConstants.ID + ":yeti_wall_trophy", new TrophyWallBlock(BossVariant.ALPHA_YETI));
	public static final TrophyWallBlock quest_ram_wall_trophy      = Registry.register(Registry.BLOCK, TFConstants.ID + ":quest_ram_wall_trophy", new TrophyWallBlock(BossVariant.QUEST_RAM));
	public static final Block stronghold_shield           = Registry.register(Registry.BLOCK, TFConstants.ID + ":stronghold_shield", new StrongholdShieldBlock(BlockBehaviour.Properties.of(Material.STONE).requiresCorrectToolForDrops().strength(-1.0F, 6000000.0F).sound(SoundType.METAL).noDrops()));
	public static final Block trophy_pedestal             = Registry.register(Registry.BLOCK, TFConstants.ID + ":trophy_pedestal", new TrophyPedestalBlock(BlockBehaviour.Properties.of(Material.STONE).requiresCorrectToolForDrops().strength(2.0F, 2000.0F).sound(SoundType.STONE)));
	public static final Block aurora_block                = Registry.register(Registry.BLOCK, TFConstants.ID + ":aurora_block", new AuroraBrickBlock(BlockBehaviour.Properties.of(Material.ICE_SOLID).strength(10.0F, 10.0F)));
	public static final RotatedPillarBlock aurora_pillar  = Registry.register(Registry.BLOCK, TFConstants.ID + ":aurora_pillar", new RotatedPillarBlock(BlockBehaviour.Properties.of(Material.ICE_SOLID).requiresCorrectToolForDrops().strength(2.0F, 10.0F)));
	public static final Block aurora_slab                 = Registry.register(Registry.BLOCK, TFConstants.ID + ":aurora_slab", new SlabBlock(BlockBehaviour.Properties.of(Material.ICE_SOLID).requiresCorrectToolForDrops().strength(2.0F, 10.0F)));
	public static final Block auroralized_glass           = Registry.register(Registry.BLOCK, TFConstants.ID + ":auroralized_glass", new AuroralizedGlassBlock(BlockBehaviour.Properties.of(Material.ICE).noOcclusion()));
	public static final Block underbrick                  = Registry.register(Registry.BLOCK, TFConstants.ID + ":underbrick", new Block(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.WOOD).requiresCorrectToolForDrops().strength(1.5F, 10.0F).sound(SoundType.STONE)));
	public static final Block underbrick_mossy            = Registry.register(Registry.BLOCK, TFConstants.ID + ":underbrick_mossy", new Block(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.WOOD).requiresCorrectToolForDrops().strength(1.5F, 10.0F).sound(SoundType.STONE)));
	public static final Block underbrick_cracked          = Registry.register(Registry.BLOCK, TFConstants.ID + ":underbrick_cracked", new Block(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.WOOD).requiresCorrectToolForDrops().strength(1.5F, 10.0F).sound(SoundType.STONE)));
	public static final Block underbrick_floor            = Registry.register(Registry.BLOCK, TFConstants.ID + ":underbrick_floor", new Block(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.WOOD).requiresCorrectToolForDrops().strength(1.5F, 10.0F).sound(SoundType.STONE)));
	public static final Block brown_thorns                = Registry.register(Registry.BLOCK, TFConstants.ID + ":brown_thorns", new ThornsBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.PODZOL).strength(50.0F, 2000.0F).sound(SoundType.WOOD).noDrops()));
	public static final Block green_thorns                = Registry.register(Registry.BLOCK, TFConstants.ID + ":green_thorns", new ThornsBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.PLANT).strength(50.0F, 2000.0F).sound(SoundType.WOOD).noDrops()));
	public static final Block burnt_thorns                = Registry.register(Registry.BLOCK, TFConstants.ID + ":burnt_thorns", new BurntThornsBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.STONE).strength(0.01F, 0.0F).sound(SoundType.SAND).noDrops()));
	public static final Block thorn_rose                  = Registry.register(Registry.BLOCK, TFConstants.ID + ":thorn_rose", new ThornRoseBlock(BlockBehaviour.Properties.of(Material.PLANT).strength(10.0F, 0.0F).sound(SoundType.GRASS).noCollission()));
	public static final Block thorn_leaves                = Registry.register(Registry.BLOCK, TFConstants.ID + ":thorn_leaves", new TFLeavesBlock(BlockBehaviour.Properties.of(Material.LEAVES).strength(0.2F).randomTicks().noOcclusion().sound(SoundType.AZALEA_LEAVES)));
	public static final Block beanstalk_leaves            = Registry.register(Registry.BLOCK, TFConstants.ID + ":beanstalk_leaves", new TFLeavesBlock(BlockBehaviour.Properties.of(Material.LEAVES).strength(0.2F).randomTicks().noOcclusion().sound(SoundType.AZALEA_LEAVES)));
	public static final Block deadrock                    = Registry.register(Registry.BLOCK, TFConstants.ID + ":deadrock", new Block(BlockBehaviour.Properties.of(Material.STONE).requiresCorrectToolForDrops().strength(100.0F, 6000000.0F).sound(SoundType.STONE)));
	public static final Block deadrock_cracked            = Registry.register(Registry.BLOCK, TFConstants.ID + ":deadrock_cracked", new Block(BlockBehaviour.Properties.of(Material.STONE).requiresCorrectToolForDrops().strength(100.0F, 6000000.0F).sound(SoundType.STONE)));
	public static final Block deadrock_weathered          = Registry.register(Registry.BLOCK, TFConstants.ID + ":deadrock_weathered", new Block(BlockBehaviour.Properties.of(Material.STONE).requiresCorrectToolForDrops().strength(100.0F, 6000000.0F).sound(SoundType.STONE)));
	public static final Block trollsteinn                 = Registry.register(Registry.BLOCK, TFConstants.ID + ":trollsteinn", new TrollsteinnBlock(BlockBehaviour.Properties.of(Material.STONE).requiresCorrectToolForDrops().strength(2.0F, 15.0F).sound(SoundType.STONE)));
	public static final Block wispy_cloud                 = Registry.register(Registry.BLOCK, TFConstants.ID + ":wispy_cloud", new HalfTransparentBlock(BlockBehaviour.Properties.of(Material.TOP_SNOW).strength(0.3F).sound(SoundType.WOOL).noOcclusion()));
	public static final Block fluffy_cloud                = Registry.register(Registry.BLOCK, TFConstants.ID + ":fluffy_cloud", new Block(BlockBehaviour.Properties.of(Material.ICE_SOLID).strength(0.8F, 0.0F).sound(SoundType.WOOL)));
	public static final Block giant_cobblestone           = Registry.register(Registry.BLOCK, TFConstants.ID + ":giant_cobblestone", new GiantBlock(BlockBehaviour.Properties.copy(Blocks.COBBLESTONE).requiresCorrectToolForDrops().strength(128, 10)));
	public static final Block giant_log                   = Registry.register(Registry.BLOCK, TFConstants.ID + ":giant_log", new GiantLogBlock(BlockBehaviour.Properties.copy(Blocks.OAK_LOG).requiresCorrectToolForDrops().strength(128, 0)));
	public static final Block giant_leaves                = Registry.register(Registry.BLOCK, TFConstants.ID + ":giant_leaves", new GiantLeavesBlock(BlockBehaviour.Properties.copy(Blocks.OAK_LEAVES).requiresCorrectToolForDrops().strength(0.2F * 64F, 0.0F).sound(SoundType.AZALEA_LEAVES).noOcclusion()));
	public static final Block giant_obsidian              = Registry.register(Registry.BLOCK, TFConstants.ID + ":giant_obsidian", new GiantBlock(BlockBehaviour.Properties.copy(Blocks.OBSIDIAN).requiresCorrectToolForDrops().strength(50.0F * 64F * 64F, 2000.0F * 64F * 64F)));
	public static final Block uberous_soil                = Registry.register(Registry.BLOCK, TFConstants.ID + ":uberous_soil", new UberousSoilBlock(BlockBehaviour.Properties.of(Material.DIRT).strength(0.6F).sound(SoundType.GRAVEL)));
	public static final Block huge_stalk                  = Registry.register(Registry.BLOCK, TFConstants.ID + ":huge_stalk", new Block(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.PLANT).strength(1.25F, 7.0F).sound(SoundType.GRASS)));
	public static final Block huge_mushgloom              = Registry.register(Registry.BLOCK, TFConstants.ID + ":huge_mushgloom", new HugeMushroomBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE).strength(0.2F).sound(SoundType.WOOD).lightLevel((state) -> 5)));
	public static final Block huge_mushgloom_stem         = Registry.register(Registry.BLOCK, TFConstants.ID + ":huge_mushgloom_stem", new HugeMushroomBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE).strength(0.2F).sound(SoundType.WOOD).lightLevel((state) -> 5)));
	public static final Block trollvidr                   = Registry.register(Registry.BLOCK, TFConstants.ID + ":trollvidr", new TrollRootBlock(BlockBehaviour.Properties.of(Material.PLANT).sound(SoundType.GRASS).noCollission()));
	public static final Block unripe_trollber             = Registry.register(Registry.BLOCK, TFConstants.ID + ":unripe_trollber", new UnripeTorchClusterBlock(BlockBehaviour.Properties.of(Material.PLANT).sound(SoundType.GRASS).noCollission().randomTicks()));
	public static final Block trollber                    = Registry.register(Registry.BLOCK, TFConstants.ID + ":trollber", new TrollRootBlock(BlockBehaviour.Properties.of(Material.PLANT).sound(SoundType.GRASS).noCollission().lightLevel((state) -> 15)));
	public static final HugeLilyPadBlock huge_lilypad     = Registry.register(Registry.BLOCK, TFConstants.ID + ":huge_lilypad", new HugeLilyPadBlock(BlockBehaviour.Properties.of(Material.PLANT).sound(SoundType.GRASS)));
	public static final Block huge_waterlily              = Registry.register(Registry.BLOCK, TFConstants.ID + ":huge_waterlily", new HugeWaterLilyBlock(BlockBehaviour.Properties.of(Material.PLANT).sound(SoundType.GRASS)));
	public static final RotatedPillarBlock slider         = Registry.register(Registry.BLOCK, TFConstants.ID + ":slider", new SliderBlock());
	public static final Block castle_brick                = Registry.register(Registry.BLOCK, TFConstants.ID + ":castle_brick", new CastleBlock(MaterialColor.QUARTZ));
	public static final Block castle_brick_worn           = Registry.register(Registry.BLOCK, TFConstants.ID + ":castle_brick_worn", new CastleBlock(MaterialColor.QUARTZ));
	public static final Block castle_brick_cracked        = Registry.register(Registry.BLOCK, TFConstants.ID + ":castle_brick_cracked", new CastleBlock(MaterialColor.QUARTZ));
	public static final Block castle_brick_roof           = Registry.register(Registry.BLOCK, TFConstants.ID + ":castle_brick_roof", new CastleBlock(MaterialColor.COLOR_GRAY));
	public static final Block castle_brick_mossy          = Registry.register(Registry.BLOCK, TFConstants.ID + ":castle_brick_mossy", new CastleBlock(MaterialColor.QUARTZ));
	public static final Block castle_brick_frame          = Registry.register(Registry.BLOCK, TFConstants.ID + ":castle_brick_frame", new CastleBlock(MaterialColor.QUARTZ));
	public static final Block castle_pillar_encased       = Registry.register(Registry.BLOCK, TFConstants.ID + ":castle_pillar_encased", new RotatedPillarBlock(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.QUARTZ).requiresCorrectToolForDrops().strength(100.0F, 35.0F).sound(SoundType.STONE)));
	public static final Block castle_pillar_encased_tile  = Registry.register(Registry.BLOCK, TFConstants.ID + ":castle_pillar_encased_tile", new Block(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.QUARTZ).requiresCorrectToolForDrops().strength(100.0F, 35.0F).sound(SoundType.STONE)));
	public static final Block castle_pillar_bold          = Registry.register(Registry.BLOCK, TFConstants.ID + ":castle_pillar_bold", new RotatedPillarBlock(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.QUARTZ).requiresCorrectToolForDrops().strength(100.0F, 35.0F).sound(SoundType.STONE)));
	public static final Block castle_pillar_bold_tile     = Registry.register(Registry.BLOCK, TFConstants.ID + ":castle_pillar_bold_tile", new Block(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.QUARTZ).requiresCorrectToolForDrops().strength(100.0F, 35.0F).sound(SoundType.STONE)));
	public static final StairBlock castle_stairs_brick   = Registry.register(Registry.BLOCK, TFConstants.ID + ":castle_stairs_brick", new StairBlock(castle_brick.defaultBlockState(), BlockBehaviour.Properties.copy(castle_brick)));
	public static final StairBlock castle_stairs_worn    = Registry.register(Registry.BLOCK, TFConstants.ID + ":castle_stairs_worn", new StairBlock(castle_brick_worn.defaultBlockState(), BlockBehaviour.Properties.copy(castle_brick_worn)));
	public static final StairBlock castle_stairs_cracked = Registry.register(Registry.BLOCK, TFConstants.ID + ":castle_stairs_cracked", new StairBlock(castle_brick_cracked.defaultBlockState(), BlockBehaviour.Properties.copy(castle_brick_cracked)));
	public static final StairBlock castle_stairs_mossy   = Registry.register(Registry.BLOCK, TFConstants.ID + ":castle_stairs_mossy", new StairBlock(castle_brick_mossy.defaultBlockState(), BlockBehaviour.Properties.copy(castle_brick_mossy)));
	public static final StairBlock castle_stairs_encased = Registry.register(Registry.BLOCK, TFConstants.ID + ":castle_stairs_encased", new StairBlock(castle_pillar_encased.defaultBlockState(), BlockBehaviour.Properties.copy(castle_pillar_encased)));
	public static final StairBlock castle_stairs_bold    = Registry.register(Registry.BLOCK, TFConstants.ID + ":castle_stairs_bold", new StairBlock(castle_pillar_bold.defaultBlockState(), BlockBehaviour.Properties.copy(castle_pillar_bold)));
	public static final Block castle_rune_brick_pink      = Registry.register(Registry.BLOCK, TFConstants.ID + ":castle_rune_brick_pink", new Block(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.QUARTZ).requiresCorrectToolForDrops().strength(100.0F, 15.0F).sound(SoundType.STONE)));
	public static final Block castle_rune_brick_blue      = Registry.register(Registry.BLOCK, TFConstants.ID + ":castle_rune_brick_blue", new Block(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.QUARTZ).requiresCorrectToolForDrops().strength(100.0F, 15.0F).sound(SoundType.STONE)));
	public static final Block castle_rune_brick_yellow    = Registry.register(Registry.BLOCK, TFConstants.ID + ":castle_rune_brick_yellow", new Block(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.QUARTZ).requiresCorrectToolForDrops().strength(100.0F, 15.0F).sound(SoundType.STONE)));
	public static final Block castle_rune_brick_purple    = Registry.register(Registry.BLOCK, TFConstants.ID + ":castle_rune_brick_purple", new Block(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.QUARTZ).requiresCorrectToolForDrops().strength(100.0F, 15.0F).sound(SoundType.STONE)));
	public static final Block force_field_purple          = Registry.register(Registry.BLOCK, TFConstants.ID + ":force_field_purple", new ForceFieldBlock(BlockBehaviour.Properties.of(Material.BARRIER).strength(-1.0F).lightLevel((state) -> 2).noDrops().noOcclusion()));
	public static final Block force_field_pink            = Registry.register(Registry.BLOCK, TFConstants.ID + ":force_field_pink", new ForceFieldBlock(BlockBehaviour.Properties.of(Material.BARRIER).strength(-1.0F).lightLevel((state) -> 2).noDrops().noOcclusion()));
	public static final Block force_field_orange          = Registry.register(Registry.BLOCK, TFConstants.ID + ":force_field_orange", new ForceFieldBlock(BlockBehaviour.Properties.of(Material.BARRIER).strength(-1.0F).lightLevel((state) -> 2).noDrops().noOcclusion()));
	public static final Block force_field_green           = Registry.register(Registry.BLOCK, TFConstants.ID + ":force_field_green", new ForceFieldBlock(BlockBehaviour.Properties.of(Material.BARRIER).strength(-1.0F).lightLevel((state) -> 2).noDrops().noOcclusion()));
	public static final Block force_field_blue            = Registry.register(Registry.BLOCK, TFConstants.ID + ":force_field_blue", new ForceFieldBlock(BlockBehaviour.Properties.of(Material.BARRIER).strength(-1.0F).lightLevel((state) -> 2).noDrops().noOcclusion()));
	public static final Block cinder_furnace              = Registry.register(Registry.BLOCK, TFConstants.ID + ":cinder_furnace", new CinderFurnaceBlock());
	public static final RotatedPillarBlock cinder_log     = Registry.register(Registry.BLOCK, TFConstants.ID + ":cinder_log", new TFLogBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_GRAY).strength(1.0F)));
	public static final Block cinder_wood                 = Registry.register(Registry.BLOCK, TFConstants.ID + ":cinder_wood", new Block(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_GRAY).strength(1.0F)));
	public static final Block castle_door_yellow          = Registry.register(Registry.BLOCK, TFConstants.ID + ":castle_door_yellow", new CastleDoorBlock(BlockBehaviour.Properties.of(Material.STONE, (state) -> state.getValue(CastleDoorBlock.VANISHED) ? MaterialColor.NONE : MaterialColor.COLOR_CYAN).requiresCorrectToolForDrops().strength(100.0F, 35.0F)));
	public static final Block castle_door_purple          = Registry.register(Registry.BLOCK, TFConstants.ID + ":castle_door_purple", new CastleDoorBlock(BlockBehaviour.Properties.of(Material.STONE, (state) -> state.getValue(CastleDoorBlock.VANISHED) ? MaterialColor.NONE : MaterialColor.COLOR_CYAN).requiresCorrectToolForDrops().strength(100.0F, 35.0F)));
	public static final Block castle_door_pink            = Registry.register(Registry.BLOCK, TFConstants.ID + ":castle_door_pink", new CastleDoorBlock(BlockBehaviour.Properties.of(Material.STONE, (state) -> state.getValue(CastleDoorBlock.VANISHED) ? MaterialColor.NONE : MaterialColor.COLOR_CYAN).requiresCorrectToolForDrops().strength(100.0F, 35.0F)));
...
//	public static final Block final_castle_miniature_structure = Registry.register(Registry.BLOCK, TwilightForestMod.ID + ":final_castle_miniature_structure", new BlockTFMiniatureStructure());
	public static final Block knightmetal_block = Registry.register(Registry.BLOCK, TFConstants.ID + ":knightmetal_block", new KnightmetalBlock(BlockBehaviour.Properties.of(Material.METAL).requiresCorrectToolForDrops().strength(5.0F, 41.0F).sound(SoundType.NETHERITE_BLOCK)));
	public static final Block ironwood_block = Registry.register(Registry.BLOCK, TFConstants.ID + ":ironwood_block", new CompressedBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(5.0F, 10.0F).sound(SoundType.WOOD)));
	public static final Block fiery_block = Registry.register(Registry.BLOCK, TFConstants.ID + ":fiery_block", new CompressedBlock(BlockBehaviour.Properties.of(Material.METAL, MaterialColor.TERRACOTTA_BLACK).requiresCorrectToolForDrops().strength(5.0F, 10.0F).sound(SoundType.METAL).noOcclusion().emissiveRendering((state, world, pos) -> true)));
	public static final Block steeleaf_block = Registry.register(Registry.BLOCK, TFConstants.ID + ":steeleaf_block", new CompressedBlock(BlockBehaviour.Properties.of(Material.LEAVES, MaterialColor.PLANT).strength(5.0F, 10.0F).sound(SoundType.MOSS)));
	public static final Block arctic_fur_block = Registry.register(Registry.BLOCK, TFConstants.ID + ":arctic_fur_block", new CompressedBlock(BlockBehaviour.Properties.of(Material.WOOL, MaterialColor.WOOL).strength(0.8F, 10.0F).sound(SoundType.WOOL)));
	public static final Block carminite_block = Registry.register(Registry.BLOCK, TFConstants.ID + ":carminite_block", new CompressedBlock(BlockBehaviour.Properties.of(Material.CLAY, MaterialColor.COLOR_RED).strength(0.0F, 10.0F).sound(SoundType.SLIME_BLOCK)));
	public static final Block spiral_bricks = Registry.register(Registry.BLOCK, TFConstants.ID + ":spiral_bricks", new SpiralBrickBlock());
	public static final Block etched_nagastone = Registry.register(Registry.BLOCK, TFConstants.ID + ":etched_nagastone", new EtchedNagastoneBlock(BlockBehaviour.Properties.of(Material.STONE).requiresCorrectToolForDrops().strength(1.5F, 10.0F).sound(SoundType.STONE)));
	public static final Block nagastone_pillar = Registry.register(Registry.BLOCK, TFConstants.ID + ":nagastone_pillar", new NagastonePillarBlock());
	public static final StairBlock nagastone_stairs_left = Registry.register(Registry.BLOCK, TFConstants.ID + ":nagastone_stairs_left", new StairBlock(etched_nagastone.defaultBlockState(), BlockBehaviour.Properties.copy(etched_nagastone)));
	public static final StairBlock nagastone_stairs_right = Registry.register(Registry.BLOCK, TFConstants.ID + ":nagastone_stairs_right", new StairBlock(etched_nagastone.defaultBlockState(), BlockBehaviour.Properties.copy(etched_nagastone)));
	public static final Block etched_nagastone_mossy = Registry.register(Registry.BLOCK, TFConstants.ID + ":etched_nagastone_mossy", new EtchedNagastoneBlock(BlockBehaviour.Properties.of(Material.STONE).requiresCorrectToolForDrops().strength(1.5F, 10.0F).sound(SoundType.STONE)));
	public static final Block nagastone_pillar_mossy = Registry.register(Registry.BLOCK, TFConstants.ID + ":nagastone_pillar_mossy", new NagastonePillarBlock());
	public static final StairBlock nagastone_stairs_mossy_left = Registry.register(Registry.BLOCK, TFConstants.ID + ":nagastone_stairs_mossy_left", new StairBlock(etched_nagastone_mossy.defaultBlockState(), BlockBehaviour.Properties.copy(etched_nagastone_mossy)));
	public static final StairBlock nagastone_stairs_mossy_right = Registry.register(Registry.BLOCK, TFConstants.ID + ":nagastone_stairs_mossy_right", new StairBlock(etched_nagastone_mossy.defaultBlockState(), BlockBehaviour.Properties.copy(etched_nagastone_mossy)));
	public static final Block etched_nagastone_weathered = Registry.register(Registry.BLOCK, TFConstants.ID + ":etched_nagastone_weathered", new EtchedNagastoneBlock(BlockBehaviour.Properties.of(Material.STONE).strength(1.5F, 10.0F).sound(SoundType.STONE)));
	public static final Block nagastone_pillar_weathered = Registry.register(Registry.BLOCK, TFConstants.ID + ":nagastone_pillar_weathered", new NagastonePillarBlock());
	public static final StairBlock nagastone_stairs_weathered_left = Registry.register(Registry.BLOCK, TFConstants.ID + ":nagastone_stairs_weathered_left", new StairBlock(etched_nagastone_weathered.defaultBlockState(), BlockBehaviour.Properties.copy(etched_nagastone_weathered)));
	public static final StairBlock nagastone_stairs_weathered_right = Registry.register(Registry.BLOCK, TFConstants.ID + ":nagastone_stairs_weathered_right", new StairBlock(etched_nagastone_weathered.defaultBlockState(), BlockBehaviour.Properties.copy(etched_nagastone_weathered)));
	public static final Block iron_ladder = Registry.register(Registry.BLOCK, TFConstants.ID + ":iron_ladder", new IronLadderBlock(BlockBehaviour.Properties.of(Material.DECORATION).requiresCorrectToolForDrops().strength(5.0F, 10.0F).sound(SoundType.METAL).noOcclusion()));
	...
	public static final RotatedPillarBlock stone_twist = Registry.register(Registry.BLOCK, TFConstants.ID + ":stone_twist", new RotatedPillarBlock(BlockBehaviour.Properties.of(Material.STONE).requiresCorrectToolForDrops().strength(1.5F, 6.0F)));
	public static final Block stone_twist_thin = Registry.register(Registry.BLOCK, TFConstants.ID + ":stone_twist_thin", new WallPillarBlock(Material.STONE, 12, 16));
	...
	public static final KeepsakeCasketBlock keepsake_casket = Registry.register(Registry.BLOCK, TFConstants.ID + ":keepsake_casket", new KeepsakeCasketBlock());
	public static final RotatedPillarBlock stone_bold = Registry.register(Registry.BLOCK, TFConstants.ID + ":stone_pillar_bold", new RotatedPillarBlock(BlockBehaviour.Properties.of(Material.STONE).requiresCorrectToolForDrops().strength(1.5F, 6.0F)));
	public static final Block tome_spawner = Registry.register(Registry.BLOCK, TFConstants.ID + ":death_tome_spawner", new TomeSpawnerBlock(BlockBehaviour.Properties.of(Material.WOOD).strength(2.5F).sound(SoundType.WOOD)));
	public static final Block empty_bookshelf = Registry.register(Registry.BLOCK, TFConstants.ID + ":empty_bookshelf", new Block(BlockBehaviour.Properties.of(Material.WOOD).strength(1.5F).sound(SoundType.WOOD)));
	public static final CandelabraBlock candelabra = Registry.register(Registry.BLOCK, TFConstants.ID + ":candelabra", new CandelabraBlock(BlockBehaviour.Properties.of(Material.METAL, MaterialColor.STONE).lightLevel(state -> state.getValue(CandelabraBlock.LIT) ? 15 : 0)));
