...
public class TFGameRules {
	...
	public static final GameRule<Boolean> ENFORCED_PROGRESSION_RULE = registerBoolean("twilightforest_enforced_progression", GameRuleCategory.UPDATES, true);
	public static final GameRule<Integer> TF_PORTAL_DEFAULT_DELAY = registerInteger("players_twilight_portal_default_delay", GameRuleCategory.PLAYER, 60, 0);
	public static final GameRule<Integer> TF_PORTAL_CREATIVE_DELAY = registerInteger("players_twilight_portal_creative_delay", GameRuleCategory.PLAYER, 0, 0);
