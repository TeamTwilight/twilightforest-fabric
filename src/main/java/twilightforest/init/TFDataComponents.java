...
public class TFDataComponents {
	public static final DeferredRegister<DataComponentType<?>> COMPONENTS = DeferredRegister.create(Registries.DATA_COMPONENT_TYPE, TwilightForestMod.ID);
	...
	public static final DeferredHolder<DataComponentType<?>, DataComponentType<Unit>> TRAVELLERS_HAS_BELT = COMPONENTS.register("has_travellers_belt", () -> DataComponentType.<Unit>builder().persistent(Codec.unit(Unit.INSTANCE)).networkSynchronized(StreamCodec.unit(Unit.INSTANCE)).cacheEncoding().build());
	public static final DeferredHolder<DataComponentType<?>, DataComponentType<Unit>> TRAVELLERS_HAS_WINGS = COMPONENTS.register("has_travellers_wings", () -> DataComponentType.<Unit>builder().persistent(Codec.unit(Unit.INSTANCE)).networkSynchronized(StreamCodec.unit(Unit.INSTANCE)).cacheEncoding().build());
	public static final DeferredHolder<DataComponentType<?>, DataComponentType<Unit>> TRAVELLERS_HAS_BOOTS = COMPONENTS.register("has_travellers_boots", () -> DataComponentType.<Unit>builder().persistent(Codec.unit(Unit.INSTANCE)).networkSynchronized(StreamCodec.unit(Unit.INSTANCE)).cacheEncoding().build());
	...
	public static final DeferredHolder<DataComponentType<?>, DataComponentType<Unit>> RED_THREAD_VISION = COMPONENTS.register("red_thread_vision", () -> DataComponentType.<Unit>builder().persistent(Codec.unit(Unit.INSTANCE)).networkSynchronized(StreamCodec.unit(Unit.INSTANCE)).cacheEncoding().build());
	public static final DeferredHolder<DataComponentType<?>, DataComponentType<Unit>> STEALTH_CROUCHING = COMPONENTS.register("stealth_crouching", () -> DataComponentType.<Unit>builder().persistent(Codec.unit(Unit.INSTANCE)).networkSynchronized(StreamCodec.unit(Unit.INSTANCE)).cacheEncoding().build());
	public static final DeferredHolder<DataComponentType<?>, DataComponentType<Unit>> ARROW_MAGNETISM = COMPONENTS.register("arrow_magnetism", () -> DataComponentType.<Unit>builder().persistent(Codec.unit(Unit.INSTANCE)).networkSynchronized(StreamCodec.unit(Unit.INSTANCE)).cacheEncoding().build());
	...
	public static final DeferredHolder<DataComponentType<?>, DataComponentType<Unit>> SWAP_HOTBAR_ABILITY = COMPONENTS.register("swap_hotbar_ability", () -> DataComponentType.<Unit>builder().persistent(Codec.unit(Unit.INSTANCE)).networkSynchronized(StreamCodec.unit(Unit.INSTANCE)).cacheEncoding().build());
	public static final DeferredHolder<DataComponentType<?>, DataComponentType<Unit>> SWAP_HOTBAR_MODIFIER = COMPONENTS.register("swap_hotbar_modifier", () -> DataComponentType.<Unit>builder().persistent(Codec.unit(Unit.INSTANCE)).networkSynchronized(StreamCodec.unit(Unit.INSTANCE)).cacheEncoding().build());
	...
	public static final DeferredHolder<DataComponentType<?>, DataComponentType<Unit>> DOUBLE_JUMP = COMPONENTS.register("double_jump", () -> DataComponentType.<Unit>builder().persistent(Codec.unit(Unit.INSTANCE)).networkSynchronized(StreamCodec.unit(Unit.INSTANCE)).cacheEncoding().build());
	...
	public static final DeferredHolder<DataComponentType<?>, DataComponentType<Unit>> UNRESTRAINED = COMPONENTS.register("unrestrained", () -> DataComponentType.<Unit>builder().persistent(Codec.unit(Unit.INSTANCE)).networkSynchronized(StreamCodec.unit(Unit.INSTANCE)).cacheEncoding().build());

	public static final DeferredHolder<DataComponentType<?>, DataComponentType<Unit>> SWIFT_SWIM = COMPONENTS.register("swift_swim", () -> DataComponentType.<Unit>builder().persistent(Codec.unit(Unit.INSTANCE)).networkSynchronized(StreamCodec.unit(Unit.INSTANCE)).cacheEncoding().build());
	public static final DeferredHolder<DataComponentType<?>, DataComponentType<Unit>> HIGH_STEP = COMPONENTS.register("high_step", () -> DataComponentType.<Unit>builder().persistent(Codec.unit(Unit.INSTANCE)).networkSynchronized(StreamCodec.unit(Unit.INSTANCE)).cacheEncoding().build());
