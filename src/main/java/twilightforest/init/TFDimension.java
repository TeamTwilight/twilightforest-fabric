...
public class TFDimension {
	...
	public static final Identifier DIMENSION = TFMain.prefix("twilight_forest");
	...
	public static final Identifier DIMENSION_RENDERER = TFMain.prefix("renderer");
	...
	public static boolean isTwilightWorldOnClient(Level clientWorld) {
		return TFMain.ID.equals(clientWorld.dimension().identifier().getNamespace()) || isTwilightPortalDestination(clientWorld);
	}
}