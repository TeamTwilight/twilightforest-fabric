...
public class TravellersModifierTypes {
	...
	public static final DeferredRegister<MapCodec<? extends TravellersModifier>> TYPES = DeferredRegister.create(TFRegistries.Keys.TRAVELLERS_MODIFIER_TYPE, TFMain.ID);
