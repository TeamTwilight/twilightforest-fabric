...
public class ItemDisplays {
	...
	public static final DeferredHolder<ItemDisplayType, ItemDisplayType> MOON_DIAL = DISPLAYS.register("moon_dial", () -> new ItemDisplayType(stack -> stack.is(TFItems.MOON_DIAL.get()), () -> new MoonDialDisplay(), Optional.of(TwilightForestMod.prefix("textures/item/moon_dial_display.png"))));
}
