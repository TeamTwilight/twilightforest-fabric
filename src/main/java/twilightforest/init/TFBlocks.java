...
//	public static final RegistryObject<Block> FINAL_CASTLE_MINIATURE_STRUCTURE = BLOCKS.register("final_castle_miniature_structure", () -> new Block(BlockBehaviour.Properties.of(Material.BARRIER).requiresCorrectToolForDrops().strength(0.75F).noOcclusion()));
	...
	public static final RegistryObject<StandingSignBlock> DARKWOOD_SIGN = BLOCKS.register("darkwood_sign", () -> new TFSignBlock(BlockBehaviour.Properties.copy(DARK_PLANKS.get()).strength(1.0F).noOcclusion().noCollission(), TFWoodTypes.DARKWOOD_WOOD_TYPE));
	public static final RegistryObject<WallSignBlock> DARKWOOD_WALL_SIGN = BLOCKS.register("darkwood_wall_sign", () -> new TFWallSignBlock(BlockBehaviour.Properties.copy(DARK_PLANKS.get()).strength(1.0F).noOcclusion().noCollission(), TFWoodTypes.DARKWOOD_WOOD_TYPE));
