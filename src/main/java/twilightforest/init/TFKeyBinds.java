...
public abstract class TFKeyBinds {
	...
	public static final KeyMapping ITEM_DISPLAY_MAP_CYCLE_KEY = register("item_display_map_cycle", InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_B, TFKeyBindsCategories.TRAVELLERS_GEAR);
