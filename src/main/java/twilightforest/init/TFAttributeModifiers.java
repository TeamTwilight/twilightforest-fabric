...
public final class TFAttributeModifiers {
    ...
    public static final AttributeModifier TRAVELLERS_DOUBLE_JUMP_SAFE_FALL_DISTANCE = new AttributeModifier(TwilightForestMod.prefix("travellers_gear.boots_double_jump_safe_fall_distance"), 2.0F, AttributeModifier.Operation.ADD_VALUE);
    public static final AttributeModifier TRAVELLERS_SWIFT_SWIM = new AttributeModifier(TwilightForestMod.prefix("travellers_gear.vest_fast_swimming"), 1.0F, AttributeModifier.Operation.ADD_VALUE);
