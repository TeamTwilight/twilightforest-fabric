...
public class TFBiomes {
	...
	public static void bootstrap(BootstrapContext<Biome> context) {
		...
		TFGrassColorModifiers.register(SPOOKY_FOREST, (x, z, color) -> biomeColorAlgorithms.spookyGrass(x, z));
		...
		TFGrassColorModifiers.register(ENCHANTED_FOREST, (x, z, color) -> biomeColorAlgorithms.enchanted(color, (int) x, (int) z));
		...
		TFGrassColorModifiers.register(SWAMP, (x, z, color) -> biomeColorAlgorithms.swamp(BiomeColorAlgorithms.Type.Grass));
		...
		TFGrassColorModifiers.register(DARK_FOREST, (x, z, color) -> biomeColorAlgorithms.darkForest(BiomeColorAlgorithms.Type.Grass));
		...
		TFGrassColorModifiers.register(DARK_FOREST_CENTER, (x, z, color) -> biomeColorAlgorithms.darkForestCenterGrass(x, z));
