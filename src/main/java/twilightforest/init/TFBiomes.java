...
public final class TFBiomes {
    ...
    public static void bootstrap(BootstrapContext<Biome> context) {
        ...
        context.register(SPOOKY_FOREST, biomeWithDefaults(defaultAmbientBuilder().grassColorOverride(0xC45123).foliageColorOverride(0xFF8501).fogColor(0x827391).waterColor(0xBC8857).waterFogColor(0xBC8857).grassColorModifier(TFGrassColorModifierEnumExtension.SPOOKY_FOREST), spookSpawning(), spookyForestGen(featureGetter, carverGetter)).temperature(0.5F).downfall(1).build());
        context.register(ENCHANTED_FOREST, biomeWithDefaults(fireflyParticles(defaultAmbientBuilder()).foliageColorOverride(0x00FFFF).grassColorOverride(0x00FFFF).grassColorModifier(TFGrassColorModifierEnumExtension.ENCHANTED_FOREST), defaultMobSpawning(), enchantedForestGen(featureGetter, carverGetter)).hasPrecipitation(false).build());
