...
public class TFCreativeTabs {
	public static final ResourceKey<CreativeModeTab> BLOCKS_KEY = ResourceKey.create(BuiltInRegistries.CREATIVE_MODE_TAB.key(), TFCommon.prefix("blocks"));
	public static final ResourceKey<CreativeModeTab> ITEMS_KEY = ResourceKey.create(BuiltInRegistries.CREATIVE_MODE_TAB.key(), TFCommon.prefix("items"));
	public static final ResourceKey<CreativeModeTab> EQUIPMENT_KEY = ResourceKey.create(BuiltInRegistries.CREATIVE_MODE_TAB.key(), TFCommon.prefix("equipment"));
	public static final ResourceKey<CreativeModeTab> FOOD_KEY = ResourceKey.create(BuiltInRegistries.CREATIVE_MODE_TAB.key(), TFCommon.prefix("key"));
	...
	public static void addToTabs() {
		...
		CreativeModeTabEvents.modifyOutputEvent(CreativeModeTabs.OP_BLOCKS).register(output -> output.getContext().holders().lookupOrThrow(TFRegistries.Keys.MAGIC_PAINTINGS)
	...
	private static void register(ResourceKey<CreativeModeTab> key, CreativeModeTab tab) {
		Registry.register(
