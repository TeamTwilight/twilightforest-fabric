...
public final class ConfigComments {
	...
	public static final String MANUAL_TRAVELLERS_WINGS_CONTROLLED_FALL = "When this option is off, slow falling is the default. Holding the sneak key makes you fall at normal speed. When this option is on, normal falling is the default. Holding the sneak key activates slow falling.";
