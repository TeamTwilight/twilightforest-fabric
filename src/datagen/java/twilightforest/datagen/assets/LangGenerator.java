...
public class LangGenerator extends TFLangProvider {
	...
	public LangGenerator(FabricPackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
	...
	protected void addTranslations(HolderLookup.Provider registries) {
		...
		this.add(TFBlocks.WORN_CASTLE_BRICK, "Worn Castle Brick");
		this.add(TFBlocks.THICK_CASTLE_BRICK, "Thick Castle Brick");
		this.add(TFBlocks.CASTLE_ROOF_TILE, "Castle Roof Tile");
		this.add(TFBlocks.ENCASED_CASTLE_BRICK_PILLAR, "Encased Castle Brick Pillar");
		this.add(TFBlocks.ENCASED_CASTLE_BRICK_TILE, "Encased Castle Brick Tile");
		this.add(TFBlocks.BOLD_CASTLE_BRICK_PILLAR, "Bold Castle Brick Pillar");
		this.add(TFBlocks.BOLD_CASTLE_BRICK_TILE, "Bold Castle Brick Tile");
		this.add(TFBlocks.WORN_CASTLE_BRICK_STAIRS, "Worn Castle Brick Stairs");
		this.add(TFBlocks.ENCASED_CASTLE_BRICK_STAIRS, "Encased Castle Brick Stairs");
		this.add(TFBlocks.BOLD_CASTLE_BRICK_STAIRS, "Bold Castle Brick Stairs");

		this.add(TFBlocks.PINK_CASTLE_RUNE_BRICK, "Magenta Castle Rune Brick");
		this.add(TFBlocks.YELLOW_CASTLE_RUNE_BRICK, "Yellow Castle Rune Brick");
		this.add(TFBlocks.BLUE_CASTLE_RUNE_BRICK, "Blue Castle Rune Brick");
		this.add(TFBlocks.VIOLET_CASTLE_RUNE_BRICK, "Violet Castle Rune Brick");

		this.add(TFBlocks.PINK_CASTLE_DOOR, "Magenta Castle Door");
		this.add(TFBlocks.YELLOW_CASTLE_DOOR, "Yellow Castle Door");
		this.add(TFBlocks.BLUE_CASTLE_DOOR, "Blue Castle Door");
		this.add(TFBlocks.VIOLET_CASTLE_DOOR, "Violet Castle Door");

		this.add(TFBlocks.PINK_FORCE_FIELD, "Magenta Force Field");
		this.add(TFBlocks.ORANGE_FORCE_FIELD, "Orange Force Field");
		this.add(TFBlocks.GREEN_FORCE_FIELD, "Green Force Field");
		this.add(TFBlocks.BLUE_FORCE_FIELD, "Blue Force Field");
		this.add(TFBlocks.VIOLET_FORCE_FIELD, "Violet Force Field");
		...
		// locale param 1 is expected to be the moon phase from prior crowdin translations, param 2 is dimension
		this.add("item.twilightforest.moon_dial.dimension", "%2$s's moon is in %1$s phase");
		this.add("item.twilightforest.moon_dial.dimension_error", "%1$s in %2$s");
