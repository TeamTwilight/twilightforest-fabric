...
public class SoundGenerator extends TFSoundProvider {
	public SoundGenerator(FabricPackOutput output) {
		super(output);
	}
	...
	public void registerSounds() {
		...
		this.add(TFSounds.MUSIC, SoundDefinition.definition().with(
			SoundDefinition.Sound.sound(TFCommon.prefix("music/superstitious"), SoundDefinition.SoundType.SOUND).stream().volume(0.5F),
			SoundDefinition.Sound.sound(TFCommon.prefix("music/steps"), SoundDefinition.SoundType.SOUND).stream().volume(0.5F),
			SoundDefinition.Sound.sound(TFCommon.prefix("music/radiance"), SoundDefinition.SoundType.SOUND).stream().volume(0.5F),
			SoundDefinition.Sound.sound(TFCommon.prefix("music/home"), SoundDefinition.SoundType.SOUND).stream().volume(0.5F),
			SoundDefinition.Sound.sound(TFCommon.prefix("music/wayfarer"), SoundDefinition.SoundType.SOUND).stream().volume(0.5F),
			SoundDefinition.Sound.sound(TFCommon.prefix("music/findings"), SoundDefinition.SoundType.SOUND).stream().volume(0.5F),
			SoundDefinition.Sound.sound(TFCommon.prefix("music/maker"), SoundDefinition.SoundType.SOUND).stream().volume(0.5F),
			SoundDefinition.Sound.sound(TFCommon.prefix("music/thread"), SoundDefinition.SoundType.SOUND).stream().volume(0.5F),
			SoundDefinition.Sound.sound(TFCommon.prefix("music/motion"), SoundDefinition.SoundType.SOUND).stream().volume(0.5F)));
	}
}